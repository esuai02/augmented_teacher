...
if (empty($openai_api_key)) {
    error_log('[challenge_report copy.php:' . __LINE__ . '] OPENAI_API_KEY 환경변수가 설정되지 않았습니다.');
}
...
$sessiontext='# 오늘목표 : '.$checkgoal->text.'  # 현재 세션 내용 : '.$context->text;
...
function resetChecklist() 
{
  ...
  $.ajax({
    ...
    function saveChecklist() {
        ...
        console.log("체크리스트 상태 저장됨:", savedState);
    }
    ...
    window.onload = function() {
        ...
        setTimeout(processInputAndCreateChecklist, 100);
    };
    </script>
...
$talkb1='';
$tone1='체크리스트 형식을 생성해서 체크하도록 해줘. 예, 아니오로 대답 가능한 2가지 목록 제시해줘. 주관식 답변 필요한 항목 배제해줘. 활동 중간 점검부분은 아래 예시 그대로 반영해줘.
