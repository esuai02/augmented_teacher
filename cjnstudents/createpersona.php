...
if (empty($openai_api_key)) {
    error_log('[createpersona.php:' . __LINE__ . '] OPENAI_API_KEY 환경변수가 설정되지 않았습니다.');
}
...
if($thiscnt->id!=NULL)
   ...
   // if($mode==='modify')
      ...
      $preparegpt=$cnttext.'내용을 세밀하게 검토해줘.  이 내용을 공부하는 과정에서 학생들이 겪을 수 있는 혼란과 불안요소들을 상세하게 기술해줘.표현을 학생의 구어체 어투로 해줘';
      $firstdescription ='';
      }/*
    else 
      {
...
$talka1='학생이 질문합니다';
$talkb1='멘토가 답합니다';
$tone1='아주중요해1 - 제시된 구체적인 위치에 질문을 집중해줘. 출력형식은 무조건 다음 예시와 같이 해줘. 각 단계는 따옴표로 감싸고 반드시 컴마로 분리해, 도입부 및 마무리 등의 내용 제거하고 예시의 형식 외의 다른 내용은 아예 표시하지 말아줘. 안 그러면 크게 혼난다. "1. 혼란요소","2. 혼란요소","3.  혼란요소","4.  혼란요소","5.  혼란요소"';
