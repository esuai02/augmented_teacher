...
$cjnchat=$DB->get_records_sql("SELECT * FROM mdl_abessi_cjntalk where userid='$userid' AND timecreated>'$aweekago' ORDER BY id DESC LIMIT 30");  
...
foreach(array_reverse($result) as $value)
  ...
  $DB->execute("UPDATE {abessi_cjntalk} SET mark='1'  WHERE id='$value['id']' ");
	}  
