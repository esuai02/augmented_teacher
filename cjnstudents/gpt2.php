...
if (empty($openai_api_key)) {
    error_log('[gpt2.php:' . __LINE__ . '] OPENAI_API_KEY 환경변수가 설정되지 않았습니다.');
}
?>
<!DOCTYPE html>
<html>
...
<body>
   ...
   <iframe width="560" height="315" src="https://www.youtube.com/embed/Uc7md60uAKM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</body>
