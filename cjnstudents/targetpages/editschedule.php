...
$schlog = $DB->get_records_sql("SELECT * FROM mdl_abessi_schedule WHERE userid='$studentid' AND timecreated>'$monthsago3' AND (type LIKE '기본' OR type LIKE '특강') ORDER BY timecreated DESC LIMIT 20");
...
foreach($result as $value)
	...
	$history.='<a href="https://mathking.kr/moodle/local/augmented_teacher/students/editschedule.php?id='.$studentid.'&eid='.$schid.'">'.$tedit.'</a> | ';
	}
 echo ' 
