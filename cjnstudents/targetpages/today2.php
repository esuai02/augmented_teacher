...
//$handwriting=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages WHERE  userid='$studentid'  AND hide=0 AND tlaststroke>'$timestart2' AND contentstype=2 AND  (active=1 OR flag=1 OR status='flag' OR (active=1 && status='review') )  ORDER BY tlaststroke DESC LIMIT 300 ");
//$handwriting=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages WHERE  userid='$studentid'  AND hide=0 AND tlaststroke>'$timestart2' AND contentstype=2 AND  active=1 ORDER BY tlaststroke DESC LIMIT 300 ");
$handwriting=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages WHERE  userid='$studentid'  AND hide=0 AND tlaststroke>'$timestart2' AND contentstype=2 AND  (active=1 OR status='flag' )  ORDER BY tlaststroke DESC LIMIT 300 ");
...
//if( ($value['status']==='complete' || $value['status']==='review')   &&  $value['contentstype']==2 && time()-$value['timemodified']>600 && time()-$value['timemodified']<43200 &&   $value['nretry']==1 )$imgstatus='<img src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1632547091001.png" width="15"><span style="color: rgb(233, 33, 33);">  복습</a></span>';  

$wbidbooster='booststep'.$contentsid.'_user'.$studentid;
if($value['status']==='review' && time()-$value['timemodified']+43200 > $value['treview']*86400)
	{
	$nreview2++;
	$imgstatus='<img src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1626450444001.png" width="15"> 예약';
	if($nreview2==1)
		{
...
if($value['status']==='flag' && $value['timemodified']>$adayAgo)
	{
	...
	if($status==='review')  $reviewwb.= '<tr><td  sytle="font-weight: bold;">'.$imgstatus.'  '.$fixhistory.'</td><td  sytle="font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'&studentid='.$studentid.'" target="_blank" ><div class="tooltip3"> <input type="checkbox" name="checkAccount"  '.$checkstatus.'  onClick="ChangeCheckBox2(11,\''.$studentid.'\',\''.$encryption_id.'\', this.checked)"/> '.substr($tagtitles,0,40).'&nbsp;&nbsp;'.date("m/d | H:i",$value['timemodified']).' <span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div></a><span  onClick="showWboard(\''.$encryption_id.'\')">('.$nstroke.'획)</span></td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/bessiboard/replay.php?id=bessi'.$encryption_id.'&srcid='.$encryption_id.'&studentid='.$studentid.'&mode=addexp"target="_blank">원인입력</a></td><td></td><td  sytle="font-weight: bold;"> '.$nthinktext.' </td><td>  '.$hidewb.' </td></tr> ';
	else $wboardlist0.= '<tr><td  sytle="font-weight: bold;">'.$imgstatus.'  '.$fixhistory.'</td><td  sytle="font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'&studentid='.$studentid.'" target="_blank" ><div class="tooltip3"> <input type="checkbox" name="checkAccount"  '.$checkstatus.'  onClick="ChangeCheckBox2(11,\''.$studentid.'\',\''.$encryption_id.'\', this.checked)"/> '.substr($tagtitles,0,40).'&nbsp;&nbsp;'.date("m/d | H:i",$value['timemodified']).' <span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div></a><span  onClick="showWboard(\''.$encryption_id.'\')">('.$nstroke.'획)</span></td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/bessiboard/replay.php?id=bessi'.$encryption_id.'&srcid='.$encryption_id.'&studentid='.$studentid.'&mode=addexp"target="_blank">원인입력</a></td><td></td><td  sytle="font-weight: bold;"> '.$nthinktext.' </td><td>  '.$hidewb.' </td></tr> ';
	$nflag++;
	/*		 
	if($nflag==1)$open1='https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$encryption_id;
	elseif($nflag==2)$open2='https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$encryption_id;
	elseif($nflag==3)$open3='https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$encryption_id;
	elseif($nflag==4)$open4='https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$encryption_id;
	elseif($nflag==5)$open5='https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$encryption_id;
	*/
	}
elseif($value['timemodified']>$adayAgo ) //&& $value['flag']!=1
	{
	if($status==='review') $reviewwb.= '<tr><td  sytle="font-weight: bold;">오늘 '.$imgstatus.' '.$fixhistory.'</td><td  sytle="font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'&studentid='.$studentid.'" target="_blank" ><div class="tooltip3"> <input type="checkbox" name="checkAccount"  '.$checkstatus.'  onClick="ChangeCheckBox2(11,\''.$studentid.'\',\''.$encryption_id.'\', this.checked)"/>'.substr($tagtitles,0,40).'&nbsp;&nbsp;'.date("m/d | H:i",$value['timemodified']).'  <span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div></span></a><span  onClick="showWboard(\''.$encryption_id.'\')">'.$cntinside.'</span></td><td  sytle="font-weight: bold;">&nbsp;&nbsp;</td><td  sytle="font-weight: bold;"> '.$resultValue.' '.$grader.' </td><td> '.$hidewb.'  </td></tr> ';
	else $wboardlist1.= '<tr><td  sytle="font-weight: bold;">오늘 '.$imgstatus.'  '.$fixhistory.'</td><td  sytle="font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'&studentid='.$studentid.'" target="_blank" ><div class="tooltip3"> <input type="checkbox" name="checkAccount"  '.$checkstatus.'  onClick="ChangeCheckBox2(11,\''.$studentid.'\',\''.$encryption_id.'\', this.checked)"/>'.substr($tagtitles,0,40).'&nbsp;&nbsp;'.date("m/d | H:i",$value['timemodified']).'  <span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div></span></a><span  onClick="showWboard(\''.$encryption_id.'\')">'.$cntinside.'</span></td><td  sytle="font-weight: bold;">&nbsp;&nbsp;</td><td  sytle="font-weight: bold;">  '.$resultValue.' '.$grader.' </td><td> '.$hidewb.'  </td></tr> ';
	}
elseif($value['timemodified']<=$adayAgo && $value['status']!=='flag'  && $value['helptext']!=='해결') 
	{
	if($status==='review') $reviewwb.= '<tr><td>지난 '.$imgstatus.' '.$fixhistory.'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'&studentid='.$studentid.'" target="_blank" ><div class="tooltip3"> <input type="checkbox" name="checkAccount"  '.$checkstatus.'  onClick="ChangeCheckBox2(11,\''.$studentid.'\',\''.$encryption_id.'\', this.checked)"/>'.substr($tagtitles,0,40).'&nbsp;&nbsp;'.date("m/d | H:i",$value['timemodified']).'  <span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div></a><span  onClick="showWboard(\''.$encryption_id.'\')"> '.$cntinside.'</span></td><td>&nbsp;&nbsp;</td><td>  '.$resultValue.' '.$grader.' </td><td> '.$hidewb.'  </td></tr> ';
	else $wboardlist2.= '<tr><td>지난 '.$imgstatus.' '.$fixhistory.'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'&studentid='.$studentid.'" target="_blank" ><div class="tooltip3"> <input type="checkbox" name="checkAccount"  '.$checkstatus.'  onClick="ChangeCheckBox2(11,\''.$studentid.'\',\''.$encryption_id.'\', this.checked)"/>'.substr($tagtitles,0,40).'&nbsp;&nbsp;'.date("m/d | H:i",$value['timemodified']).'  <span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div></a><span  onClick="showWboard(\''.$encryption_id.'\')"> '.$cntinside.'</span></td><td>&nbsp;&nbsp;</td><td> '.$resultValue.' '.$grader.' </td><td> '.$hidewb.'  </td></tr> ';
	}
}
...
if($indicator->nreview>=3)$result_review='<b style="color:white;">복습예약 총 '.$nreview.'회</b>';
else $result_review='<b style="color:red;">복습예약 총 '.$nreview.'회</b>';
...
$todayplan='<div class="container"><b>▶ 귀가시간 : '.$tcomplete.'</b> | '.$tleft.'
   <hr>
    ...
    <table width=100%><tr><td><h6>▶ 개선하기 : '.$ntext1.' </h6></td> </tr></table><hr><table width=100%><tr><td><h6>▶ 성찰하기 : '.$ntext10.' </h6></td> </tr></table>
...
$goalprogress='<div class="demo"><div class="progress-card"><div class="progress-status"><span class="text-muted">분기목표 성취도</span><span class="text-muted"> '.round($synapsePower,1).'%</span></div>
...
</div></div></div></div></div></div></td><td width=2%><td width=30% valign=top>'.$instructionToday.'</td></td><td width=2%></td>
</tr></table><br> ';

$attendlog = $DB->get_record_sql("SELECT * FROM mdl_abessi_attendance WHERE userid='$studentid'  ORDER by id DESC LIMIT 1 " );
$doriginal=date("Y-m-d",$attendlog->doriginal); $dchanged=date("Y-m-d",$attendlog->dchanged);
$tamounttotal=$attendlog->tamount;
$tamounttotal='&nbsp; &nbsp; &nbsp; &nbsp; <b>'.$attendlog->tupdate.'시간 </b>&nbsp;&nbsp;<a style="color:green; font-size:14pt" href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$studentid.'&eid=1&nweek=4">예기치 못한 휴강상황을 위하여 + 5시간 이상을 권합니다.</a> ';
if($attendlog->tupdate<=-5 && $attendlog->id !=NULL )$tamounttotal='&nbsp; <b>'.$attendlog->tupdate.'시간 </b>&nbsp;&nbsp;<a style="color:red; font-size:20pt" href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$studentid.'&eid=1&nweek=4">보강시간을 정해주세요 !</a> <img src="https://mathking.kr/Contents/IMAGES/exist.gif" width=60>';
$todayrecord='<table width=100%><tr style="background-color:#ccffff;"> <td width=3%></td>  <td width=10% align=left style="font-size:12pt">'.$attendlog->type.'</td><td width=10%  align=left style="font-size:12pt">'.$attendlog->reason.'</td><td  width=10% align=left style="font-size:12pt">계획  '.$doriginal.'</td><td width=10%  align=left style="font-size:12pt">변경 '.$dchanged.'</td>  <td   align=left'.$tamounttotal.'</td><td align=left style="font-size:12pt">'.$attendlog->text.'</td></tr></table>';
...
<td  style="width: 7%; padding-left: 1px;padding-bottom:3px; font-size: 20px; color:#ffffff;"><b style="color:white;">귀가요청 &nbsp;&nbsp;
 ('.($nright+$nwrong).' 문제 중 '.$nright.' 정답)</b></td></td>
<td style="font-size: 20px; width: 5%;">'.$result_review.'</td> <td style="width: 15%;"><div class="select2-input"><select id="basic1" name="basic" class="form-control" ><option value="" disabled selected>주간목표를 기준으로 평가해 주세요</option> <option value="주간목표에 도달이 가능합니다">주간목표에 도달이 가능합니다</option><option value="주간목표의 수정이 필요합니다">주간목표의 수정이 필요합니다</option></select></div></td>

<td style="width: 1%;"></td>
<td style="width: 25%;"><div><input type="text" class="form-control input-square" id="squareInput" name="squareInput"  placeholder="'.$placeholder.'" ></div></td> 
<td style="width: 1%;"></td>
<td style="width:5%;"><button type="image" onclick="submittoday(21,'.$studentid.',$(\'#basic1\').val(),$(\'#basic3\').val(),$(\'#basic5\').val(),$(\'#squareInput\').val()) ">제출하기</button></td>
</tr></table></div></div>  <br>';
// 퀴즈 및 화이트보드 출력부
