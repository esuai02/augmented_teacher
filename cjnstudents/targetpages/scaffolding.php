...
<tr style="font-size:16px;"><td style="color:#1a75ff;font-weight:bold;"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/userlist.php?id='.$studentid.'&info=phone1"target="_blank">▷</a> 연락처(학생)</td><td><div><input  style="font-size:16px;" type="text" class="form-control input-square" id="squareInput2" name="squareInput2"  placeholder="'.$phone1->data.'" value="'.$phone1->data.'" ></div></td></tr>

<tr style="font-size:16px;"><td style="color:#1a75ff;font-weight:bold;"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/userlist.php?id='.$studentid.'&info=phone2"target="_blank">▷</a> 연락처(부)</td><td><div><input  style="font-size:16px;" type="text" class="form-control input-square" id="squareInput3" name="squareInput3"  placeholder="'.$phone2->data.'" value="'.$phone2->data.'" ></div></td></tr>

<tr style="font-size:16px;"><td style="color:#1a75ff;font-weight:bold;"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/userlist.php?id='.$studentid.'&info=phone3"target="_blank">▷</a> 연락처(모)</td><td><div><input  style="font-size:16px;" type="text" class="form-control input-square" id="squareInput4" name="squareInput4"  placeholder="'.$phone3->data.'" value="'.$phone3->data.'" ></div></td></tr>
...
<tr style="font-size:16px;"><td style="color:#1a75ff;font-weight:bold;"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/userlist.php?id='.$studentid.'&info=addcourse"target="_blank">▷</a> 추천강좌</td><td><div class="select2-input"><select  style="width:250;font-size:16px;" id="basic1" name="basic1" class="form-control" ><option value="개념" '.$adselectstate1.'>개념</option><option value="심화" '.$adselectstate2.'>심화</option><option value="내신" '.$adselectstate3.'>내신</option><option value="수능" '.$adselectstate4.'>수능</option><option value="주제별특강" '.$adselectstate5.'>주제별특강</option></select></div></td></tr>
...
<td><button style="font-size:20;" type="image" onclick="saveproperties('.$studentid.',$(\'#squareInput1\').val(),$(\'#datepicker\').val(),$(\'#squareInput2\').val(),$(\'#squareInput3\').val(),$(\'#squareInput4\').val(),$(\'#squareInput5\').val(),$(\'#squareInput6\').val(),$(\'#basic1\').val(),$(\'#basic2\').val(),$(\'#basic3\').val(),$(\'#basic4\').val(),$(\'#basic5\').val(),$(\'#basic6\').val(),$(\'#basic7\').val(),$(\'#basic8\').val(),$(\'#basic9\').val(),$(\'#basic10\').val(),$(\'#basic11\').val(),$(\'#basic12\').val(),$(\'#basic13\').val(),$(\'#basic14\').val(),$(\'#basic15\').val(),$(\'#basic16\').val(),$(\'#basic17\').val(),$(\'#basic18\').val(),$(\'#basic19\').val()) ">저장하기</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="https://mathking.kr/moodle/user/editadvanced.php?id='.$studentid.'"target="_blank">개인정보 수정</a> &nbsp;&nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/students/fullplan.php?id='.$studentid.'">시간설계</a></td></tr>
</table>';                                    
