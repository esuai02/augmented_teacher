...
$missionlist = $DB->get_records_sql("SELECT * FROM mdl_abessi_curriculum WHERE name LIKE '%$missiontype%' ORDER BY id "); // missiontype으로 mission 종류 선택
...
if($subject==0)
	...
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic2" name="basic2" class="form-control" ><option value="">시작단원</option><option value="1">1단원</option><option value="2">2단원</option><option value="3">3단원</option><option value="4">4단원</option><option value="5">5단원</option><option value="6">6단원</option><option value="7">7단원</option><option value="8">8단원</option><option value="9">9단원</option><option value="10">10단원</option></select></div></th>
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic3" name="basic3" class="form-control" ><option value="">시간/단원</option><option value="3">3시간</option><option value="4">4시간</option><option value="5">5시간</option><option value="6">6시간</option><option value="7">7시간</option><option value="8">8시간</option> <option value="9">9시간</option> <option value="10">10시간</option> <option value="11">11시간</option> <option value="12">12시간</option> <option value="13">13시간</option> <option value="14">14시간</option></select></div></th>
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic5" name="basic5" class="form-control" ><option value="0">시간/주</option><option value="3">3시간</option><option value="4">4시간</option><option value="5">5시간</option><option value="6">6시간</option><option value="7">7시간</option><option value="8">8시간</option> <option value="9">9시간</option> <option value="10">10시간</option> <option value="11">11시간</option> 
	...
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic4" name="basic4" class="form-control" ><option value="">합격점수</option><option value="70">70점</option><option value="75">75점</option><option value="80">80점</option><option value="85">85점</option><option value="90">90점</option><option value="95">95점</option> <option value="100">100점</option></select></div></th>
	<th scope="col" style="width: 20%;"><input type="text" class="form-control" id="datepicker" name="datepicker"  placeholder="시작일"></th>

	<th scope="col" style="width: 5%;"><button type="button" onclick="inputmission(11,'.$studentid.','.$mtid.',$(\'#basic1\').val(),$(\'#basic4\').val(),$(\'#basic3\').val(),$(\'#basic2\').val(),$(\'#basic5\').val(),$(\'#datepicker\').val()) "><a href="https://mathking.kr/moodle/local/augmented_teacher/students/index.php?id='.$studentid.'"><img src="http://mathking.kr/Contents/Moodle/save.gif" width=30></a></button></th>
	...
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic2" name="basic2" class="form-control" ><option value="'.$chstart.'">'.$chstart.'단원</option><option value="1">1단원</option><option value="2">2단원</option><option value="3">3단원</option><option value="4">4단원</option><option value="5">5단원</option><option value="6">6단원</option><option value="7">7단원</option><option value="8">8단원</option><option value="9">9단원</option><option value="10">10단원</option></select></div></th>
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic3" name="basic3" class="form-control" ><option value="'.$hour.'">'.$hour.'시간</option><option value="3">3시간</option><option value="4">4시간</option><option value="5">5시간</option><option value="6">6시간</option><option value="7">7시간</option><option value="8">8시간</option> <option value="9">9시간</option> <option value="10">10시간</option> <option value="11">11시간</option> <option value="12">12시간</option> <option value="13">13시간</option> <option value="14">14시간</option></select></div></th>
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic4" name="basic4" class="form-control" ><option value="'.$grade.'">'.$grade.'점</option><option value="70">70점</option><option value="75">75점</option><option value="80">80점</option><option value="85">85점</option><option value="90">90점</option><option value="95">95점</option> <option value="100">100점</option></select></div></th>
	<th scope="col" style="width: 10%;"><div class="select2-input"><select id="basic5" name="basic5" class="form-control" ><option value="'.$weekhour.'">'.$weekhour.'시간</option><option value="3">3시간</option><option value="4">4시간</option><option value="5">5시간</option><option value="6">6시간</option><option value="7">7시간</option><option value="8">8시간</option> <option value="9">9시간</option> <option value="10">10시간</option> <option value="11">11시간</option> 
	<option value="12">12시간</option> <option value="13">13시간</option> <option value="14">14시간</option><option value="15">15시간</option> <option value="16">16시간</option> <option value="17">17시간</option> <option value="18">18시간</option> <option value="19">19시간</option> <option value="20">20시간</option> <option value="21">21시간</option> <option value="22">22시간</option> <option value="23">23시간</option> <option value="24">24시간</option> <option value="25">25시간</option> <option value="26">26시간</option> <option value="27">27시간</option> <option value="28">28시간</option> <option value="29">29시간</option> <option value="30">30시간</option> </select></div></th>
...
if($subject==0)
	...
	echo ' 
	<table class="table"><thead><tr>
	<th scope="col" style="width: 30%;"><div class="select2-input"><select id="basic1" name="basic1" class="form-control" ><option value=" ">과목선택</option>'.$subjects.'</select></div></th>
	<th scope="col" style="width: 20%;"><div class="select2-input"><select id="basic2" name="basic2" class="form-control" ><option value="0">시간/주</option><option value="3">3시간</option><option value="4">4시간</option><option value="5">5시간</option><option value="6">6시간</option><option value="7">7시간</option><option value="8">8시간</option> <option value="9">9시간</option> <option value="10">10시간</option> <option value="11">11시간</option> 
	<option value="12">12시간</option> <option value="13">13시간</option> <option value="14">14시간</option><option value="15">15시간</option> <option value="16">16시간</option> <option value="17">17시간</option> <option value="18">18시간</option> <option value="19">19시간</option> <option value="20">20시간</option> <option value="21">21시간</option> <option value="22">22시간</option> <option value="23">23시간</option> <option value="24">24시간</option> <option value="25">25시간</option> <option value="26">26시간</option> <option value="27">27시간</option> <option value="28">28시간</option> <option value="29">29시간</option> <option value="30">30시간</option> </select></div></th>
	<th scope="col" style="width: 20%;"><div class="select2-input"><select id="basic3" name="basic3" class="form-control" ><option value="">합격점수</option><option value="70">70점</option><option value="75">75점</option><option value="80">80점</option><option value="85">85점</option><option value="90">90점</option><option value="95">95점</option> <option value="100">100점</option></select></div></th>
	<th scope="col" style="width: 20%;"><input type="text" class="form-control" id="datepicker" name="datepicker"  placeholder="학교시험 날짜"></th>

	<th scope="col" style="width: 10%;"><button type="button" onclick="inputmission3(15,'.$studentid.','.$mtid.',$(\'#basic1\').val(),$(\'#basic2\').val(),$(\'#basic3\').val(),$(\'#datepicker\').val()) "><a href="https://mathking.kr/moodle/local/augmented_teacher/students/index.php?id='.$studentid.'"><img src="http://www.iconarchive.com/download/i103415/paomedia/small-n-flat/floppy.ico" width=30></a></button></th>
	</tr></thead><tr><div class="card-footer "></tr><div style="font: bold 1.5em/1.0em 맑은고딕체;text-align: center ;color:red;" >&nbsp;&nbsp;&nbsp; '.$missiontype.'미션을 선택해 주세요 <hr></div></table>
	...
	<th scope="col" style="width: 5%;"><button type="button" onclick="inputmission4(16,'.$studentid.','.$mtid.','.$idcreated.',$(\'#basic1\').val(),$(\'#basic2\').val(),$(\'#datepicker\').val()) "><a href="https://mathking.kr/moodle/local/augmented_teacher/students/index.php?id='.$studentid.'"><img src="http://www.iconarchive.com/download/i103415/paomedia/small-n-flat/floppy.ico" width=30></a></button></th>
	</tr>
	<tr><td></td><td>시작 단원</td><td>시간/단원</td><td>통과 점수</td><td>시간/주</td><td>시작날짜</td><td></td></tr>
	</table>
