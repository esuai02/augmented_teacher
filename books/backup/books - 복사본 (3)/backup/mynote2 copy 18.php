        ...
        if($isListeningTest && $sectionData) {
          ...
          <style>
            ...
            .listening-audio-hidden {
              ...
              margin-bottom: 12px;
              border-radius: 8px;
              display: none; /* 단계별 모드에서 오디오 플레이어 숨김 */
            }
          ...
          <div class="listening-test-container minimized" id="listeningContainer">
            <div class="listening-header">
              <div class="listening-progress" id="listeningProgress">
                🎧 구간 1/'.$sectionCount.'
                '.($role !== 'student' ? '<span onclick="toggleSubtitles()" style="margin-left:8px;cursor:pointer;text-decoration:none;font-size:0.85em;" title="자막 표시/숨기기">📄</span>' : '').'
              </div>
            ...
            <div class="listening-body">
              ...
              <div id="fullAudioControls" style="display: none !important; padding: 12px; background: rgba(255,255,255,0.1); border-radius: 8px; margin-bottom: 12px;">
                <div style="display: flex; align-items: center; gap: 8px;">
