            ...
            (function() {
              ...
              progressDots.forEach((dot, index) => {
                dot.addEventListener("click", function() {
                  ...
                  if(index === currentSection) {
                    console.log("[Dot Click] File: mynote2.php, Line: 1155, Restart current section:", currentSection);
                    audioPlayer2.currentTime = 0;
                    ...
                    audioPlayer2.play().catch(e => {
                      console.error("[Audio Error] File: mynote2.php, Line: 1163, Restart error:", e);
                    });
                    return;
                  }
