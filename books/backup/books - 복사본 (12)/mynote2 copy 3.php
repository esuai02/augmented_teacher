            ...
            (function() {
              ...
              progressDots.forEach((dot, index) => {
                dot.addEventListener("click", function() {
                  ...
                  if(index === currentSection) {
                    console.log("[Dot Click] File: mynote2.php, Line: 1155, Open drillingmath.php for section:", currentSection);
                    const url = "https://mathking.kr/moodle/local/augmented_teacher/books/drillingmath.php?section=" + currentSection;
