          ...
          <script>
            ...
            */
            ...
            (function() {
              ...
              // Progress dots 클릭 이벤트 - drillingmath.php 새탭 열기
              const progressDots = document.querySelectorAll(".progress-dot");
              progressDots.forEach((dot, index) => {
                dot.addEventListener("click", function() {
                  // 현재 재생 중인 구간을 클릭한 경우: drillingmath.php 새탭으로 열기
                  if(index === currentSection) {
                    console.log("[Dot Click] File: mynote2.php, Line: 1155, Open drillingmath.php for cid:", contentsId, "section:", currentSection);
                    const url = "https://mathking.kr/moodle/local/augmented_teacher/books/drillingmath.php?cid=" + contentsId + "&ctype=1&section=" + currentSection;
                    window.open(url, "_blank");
                    return;
                  }

                  // 다른 구간으로 이동
                  console.log("[Dot Click] File: mynote2.php, Line: 1169, From:", currentSection, "To:", index);
