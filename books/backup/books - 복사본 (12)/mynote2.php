            ...
            (function() {
              ...
              if(replayBtn) {
                replayBtn.addEventListener("click", function(e) {
                  ...
                  // nstep 계산 (1-based index)
                  const nstepValue = currentSection + 1;

                  // 현재 구간의 자막 텍스트 가져오기
                  const currentSubtitle = textSectionsData[currentSection] || "";

                  console.log("[Replay Click] File: mynote2.php, Line: 1392", {
                    contentsId: contentsId,
                    currentSection: currentSection,
                    nstep: nstepValue,
                    subtitleLength: currentSubtitle.length,
                    subtitlePreview: currentSubtitle.substring(0, 100)
                  });

                  // URL 파라미터로 전달
                  // nstep: DB 구간 번호 (1-based), section: 오디오 구간 인덱스 (0-based)
                  // subtitle: 현재 구간의 자막 텍스트 (수식 포함)
                  const url = "https://mathking.kr/moodle/local/augmented_teacher/books/drillingmath.php?cid=" + contentsId +
                              ...
                              "&subtitle=" + encodeURIComponent(currentSubtitle);
