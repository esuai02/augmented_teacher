...
if($viewmode==='note')
	...
	$btnlist='<table aligh=right><tr><td><button class="stylish-button"><a href="https://mathking.kr/moodle/local/augmented_teacher/books/mynotebook.php?studentid='.$studentid.'&vm=note"><b>▶ 노트필기</b></a></button><br><button class="stylish-button"><a href="https://mathking.kr/moodle/local/augmented_teacher/books/mynotebook.php?studentid='.$studentid.'&vm=timefolding">시간접기</a></button></td></tr></table>';
	}	
elseif($viewmode==='timefolding')
	{
	...
	foreach($result as $value) 
		...
		if($dayprev!==$thisday)
			...
			$topiclist.='<div class="card"  style="font-size:16;"><table><tr><td width=3%></td><td>'.$cntlist1.'</td></tr></table><br></div> ';
