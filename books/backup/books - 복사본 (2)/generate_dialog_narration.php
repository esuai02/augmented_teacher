...
지금 그림의 오른쪽 위를 보세요. 가장 위에 있는 정육면체 하나를 손가락으로 가리키듯 마음속으로 표시하고, 정육면체 하나의 부피는 엑스의 세제곱이라고 공책 위에 글로 적어보세요. 맞아요! 그럼 이제, 입체 전체의 부피가 왜 정육면체 오 개의 합으로 자연스럽게 연결되는지, 문장 한 줄로 써보세요.@
...
이제 스스로 풀어보기를 유도합니다. 지금 만든 구조만 보고 본문을 가리지 말고 한 번 더 천천히 읽은 뒤, 종이를 새로 펴서 동일한 절차를 당신의 문장으로 다시 써보세요. 마지막 줄에는 이제 문제만 보고 풀 수 있는지 생각해 보세요. 스스로 머릿속으로 풀어 보세요.라고 직접 적고 눈을 감고 흐름을 마음속에서 재생해 보세요.@\"
