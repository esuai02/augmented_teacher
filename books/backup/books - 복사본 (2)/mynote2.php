            ...
            (function() {
              ...
              progressDots.forEach((dot, index) => {
                dot.addEventListener("click", function() {
                  // 현재 재생 중인 구간을 클릭한 경우: 처음부터 다시 재생
                  if(index === currentSection) {
                    console.log("[Dot Click] File: mynote2.php, Line: 1154, Restart current section:", currentSection);
                    ...
                    if (savedSpeed) {
                      audioPlayer2.playbackRate = parseFloat(savedSpeed);
                      console.log("[Dot Click] File: mynote2.php, Line: 1161, Speed restored:", savedSpeed);
                    }

                    // 재생
                    audioPlayer2.play().catch(e => {
                      console.error("[Audio Error] File: mynote2.php, Line: 1166, Restart error:", e);
                    });
                  ...
                  // 다른 구간으로 이동
                  console.log("[Dot Click] File: mynote2.php, Line: 1172, From:", currentSection, "To:", index);
