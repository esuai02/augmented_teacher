      ...
      if($cnttext->audiourl2 !== NULL) {
        ...
        if($isListeningTest && $sectionData) {
          ...
          <script>
            ...
            // Toggle subtitle visibility function
            window.toggleSubtitles = function() {
              const activeSubtitle = document.querySelector(".listening-text-display.active");
              if(activeSubtitle) {
                // Hide currently visible subtitle
                activeSubtitle.classList.remove("active");
                console.log("[Subtitle Toggle] File: mynote2.php, Line: 774, Action: Hide");
              } else {
                // Show subtitle for current section
                ...
                if(subtitleToShow) {
                  ...
                  console.log("[Subtitle Toggle] File: mynote2.php, Line: 774, Action: Show, Section:", currentSectionIndex + 1);
                } else {
                  console.log("[Subtitle Toggle] File: mynote2.php, Line: 774, Error: No subtitle found for section", currentSectionIndex + 1);
                }
              }
            };
    ...
    function applyAudioMode(mode, shouldPlay) {
      ...
      if(mode === \'full\') {
        ...
        if(fullAudioSubtitleContainer) {
          ...
          console.log(\'[Full Audio Subtitle] File: mynote2.php, Line: 2847, Action: Show\');
        }
        ...
        if(activeSubtitle) {
          activeSubtitle.classList.remove(\'active\');
          console.log(\'[Listening Test Subtitle] File: mynote2.php, Line: 2854, Action: Hide\');
        }
        ...
        if(fullAudioSubtitleContainer) {
          ...
          console.log(\'[Full Audio Subtitle] File: mynote2.php, Line: 2880, Action: Hide\');
        }
