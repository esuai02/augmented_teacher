          ...
          <div class="listening-test-container minimized" id="listeningContainer">
            <div class="listening-header">
              <div class="listening-progress" id="listeningProgress">
                ...
                '.($role !== 'student' ? '<span onclick="toggleSubtitles()" style="margin-left:5px;cursor:pointer;text-decoration:none;font-size:0.85em;" title="자막 표시/숨기기">📄</span>' : '').'
              </div>
            ...
            */
            ...
            window.toggleSubtitles = function() {
              ...
              if(activeSubtitle) {
                ...
                console.log("[Subtitle Toggle] File: mynote2.php, Line: 796, Action: Hide");
              } else {
                // 자막이 숨겨져 있으면 현재 섹션의 자막 표시
                ...
                if(subtitleToShow) {
                  ...
                  console.log("[Subtitle Toggle] File: mynote2.php, Line: 796, Action: Show, Section:", currentSectionIndex + 1);
                }
              }
            };
    ...
    function applyAudioMode(mode, shouldPlay) {
      ...
      if(mode === \'full\') {
        ...
        if(fullAudioSubtitleContainer) {
          ...
          console.log(\'[Full Audio Subtitle] File: mynote2.php, Line: 2895, Action: Show\');
        }
        ...
        if(activeSubtitle) {
          activeSubtitle.classList.remove(\'active\');
          console.log(\'[Listening Test Subtitle] File: mynote2.php, Line: 2902, Action: Hide\');
        }
      } else {
