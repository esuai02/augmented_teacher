      ...
      if($cnttext->audiourl2 !== NULL) {
        ...
        if($isListeningTest && $sectionData) {
          ...
          <style>
            ...
            /* 전체재생 모드일 때는 fullAudioControls만 표시 */
            body[data-audio-mode="full"] #fullAudioControls {
              display: block !important;
            }
          ...
          <div class="listening-test-container minimized" id="listeningContainer">
            ...
            <div class="listening-body">
              <!-- Custom Audio Controls for Full Mode -->
              <div id="fullAudioControls" style="display: none; padding: 12px; background: rgba(255,255,255,0.1); border-radius: 8px; margin-bottom: 12px;">
                <div style="display: flex; align-items: center; gap: 8px;">
                  <button id="fullAudioPlayBtn"
                          class="full-audio-control-btn"
                          type="button"
                          title="재생">
                    ▶️
                  </button>
                  <button id="fullAudioPauseBtn"
                          class="full-audio-control-btn"
                          type="button"
                          title="일시정지">
                    ⏸️
                  </button>
                  <div id="fullAudioProgress" style="flex: 1; height: 4px; background: rgba(255,255,255,0.3); border-radius: 2px; position: relative;">
                    <div id="fullAudioProgressBar" style="height: 100%; background: white; border-radius: 2px; width: 0%; transition: width 0.1s;"></div>
                  </div>
                  <span id="fullAudioTime" style="font-size: 11px; color: white; min-width: 80px;">0:00 / 0:00</span>
                </div>
              </div>
