      ...
      if($cnttext->audiourl !== NULL || $cnttext->audiourl2 !== NULL) {
        ...
        if($isListeningTest && $sectionData) {
          ...
          <style>
            ...
            .listening-body {
              padding: 16px;
              min-height: 280px; /* 고정 높이로 모드 전환 시 안정성 확보 */
              max-height: 280px;
          ...
          <div class="listening-test-container minimized" id="listeningContainer">
            ...
            <div class="listening-body">
              <!-- Full audio subtitle container (전체재생모드 자막) - 플레이어 위로 이동 -->
          ...
          <script>
            ...
            function restoreAutoPlayMode() {
              const savedAutoPlayMode = localStorage.getItem("mynote_autoPlayMode");
              const toggleBtn = document.getElementById("autoPlayToggle");
              const iconSpan = document.getElementById("autoPlayIcon");
              ...
              if (savedAutoPlayMode !== null) {
                window.isAutoPlayMode = (savedAutoPlayMode === "true");
              }
              ...
              if (window.isAutoPlayMode) {
                toggleBtn.setAttribute("data-mode", "continuous");
                iconSpan.textContent = "━━";
                console.log("[Auto Play] File: mynote.php, Initialized with continuous mode");
              } else {
                toggleBtn.setAttribute("data-mode", "step");
                iconSpan.textContent = "╌╌";
                console.log("[Auto Play] File: mynote.php, Initialized with step mode");
              }
            }
          ...
          <style>
            ...
            body[data-audio-mode="full"] .listening-body {
              order: 1;
              padding: 16px; /* 명시적으로 동일한 padding */
              min-height: 280px; /* 단계별 모드와 동일한 높이 */
              max-height: 280px; /* 고정 높이로 안정성 확보 */
            ...
            /* HTML 순서로 자연스럽게 배치됨 - order 속성 제거 */
            body[data-audio-mode="full"] #fullAudioSubtitleContainer {
              flex: 1 !important; /* 가용 공간 차지 */
              overflow-y: auto !important; /* 긴 자막 스크롤 */
              min-height: 80px !important; /* 최소 높이 */
              max-height: 250px !important; /* 최대 높이 */
            ...
            body[data-audio-mode="full"] #audioPlayer2 {
              ...
              flex-shrink: 0 !important; /* 오디오 플레이어 크기 고정 */
            }
