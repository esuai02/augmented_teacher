...
// 시계 아이콘 버튼 추가
echo '<button id="callbackButton" class="btn btn-primary" title="알림 설정" style="position: fixed; top: 0; right: 10px; z-index: 1000; padding: 10px 15px; font-weight: bold; border-radius: 0 0 15px 15px; box-shadow: 0 2px 5px rgba(0,0,0,0.2); cursor: pointer; background-color: #007bff; border: none;"><i class="fas fa-clock" aria-hidden="true"></i></button>';
