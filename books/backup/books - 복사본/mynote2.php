...
if(strpos($topictitle, '특강')!==true && $npage==11111) {
  ...
  echo '</div>
        ...
        <td valign="top" width='.$width2.'%> 
          ...
          <br>
          <div id="musicPlayerArea" style="margin-bottom: 10px;"></div>
          <table>
            <tr>
              <td>
                ...
                <button onclick="uploadMusicFile('.$contentsid.')" style="margin-left:10px; cursor:pointer; background:#4CAF50; color:white; border:none; padding:5px 10px; border-radius:3px;" title="배경음악 업로드">🎵 음악</button>
              </td>
            </tr>
            <tr>
