          ...
          <div class="listening-test-container minimized" id="listeningContainer">
            <div class="listening-header">
              <div style="display: flex; align-items: center; gap: 8px;">
                ...
                '.($role !== 'student' ? '<button onclick="toggleSubtitles()" id="subtitleToggleBtn" style="background:rgba(255,255,255,0.2);border:1px solid rgba(255,255,255,0.3);color:white;padding:3px 8px;border-radius:10px;cursor:pointer;font-size:0.85em;transition:all 0.3s ease;" title="자막 표시/숨기기">📄</button>' : '').'
              </div>
              <div style="display: flex; align-items: center; gap: 8px;">
          ...
          <script>
            ...
            */
            ...
            if (typeof window.subtitlesVisible === "undefined") {
              ...
              window.subtitlesVisible = savedSubtitleState !== null ? (savedSubtitleState === "true") : true;
              console.log("[Settings] File: mynote2.php, Line: 844, Subtitle state restored from localStorage:", window.subtitlesVisible);
            }
            ...
            (function() {
              ...
              progressDots.forEach((dot, index) => {
                dot.addEventListener("click", function() {
                  ...
                  console.log("[Dot Click] File: mynote2.php, Line: 1017, From:", currentSection, "To:", index);
          ...
          <div class="listening-test-container minimized" id="listeningContainer" onclick="handleContainerClick(event)">
            <div class="listening-header" id="listeningHeader">
              <div style="display: flex; align-items: center; gap: 12px; flex: 1;">
                <button class="speed-control-btn" id="speedControlBtn" onclick="cyclePlaybackSpeed()" title="재생 속도 조절">1.0x</button>
                <button onclick="toggleAudioMode()" style="background: rgba(255,255,255,0.2); border: 1px solid rgba(255,255,255,0.4); color: white; padding: 4px 10px; border-radius: 12px; cursor: pointer; font-size: 11px; font-weight: 600; white-space: nowrap;">단계별</button>
                <div style="display: flex; align-items: center; gap: 8px;">
                  <div class="listening-progress" id="listeningProgress">
                    🎧 오디오
                  </div>
            ...
            <div class="listening-body">
              <audio id="audioPlayer2" class="listening-audio-hidden" controls src="'.$audioUrlToUse.'">
              </audio>

              <ul class="listening-progress-dots" id="progressDots">
                <li class="progress-dot active" data-section="0"></li>
              </ul>

              <div class="listening-nav-buttons">
                <button class="nav-btn" id="prevBtn" onclick="previousSection()" disabled>◀</button>
                <button class="nav-btn" id="nextBtn" onclick="nextSection()" disabled>▶</button>
              </div>
            </div>
          </div>
        ...
        <script>
          (function() {
            ...
            window.cyclePlaybackSpeed = function() {
              ...
              console.log("[Speed Change] File: mynote2.php, New Speed:", newSpeed);
            };
            ...
            // 자동 재생
            setTimeout(function() {
              audioPlayer2.play().catch(e => console.log("[Auto Play] File: mynote2.php, Blocked:", e));
            }, 500);
          })();
        </script>';
        }
  ...
  try {
    ...
    document.addEventListener(\'DOMContentLoaded\', function() {
      ...
      if (typeof window.subtitlesVisible === \'undefined\') {
        ...
        window.subtitlesVisible = savedSubtitleState !== null ? (savedSubtitleState === \'true\') : true;
        console.log(\'[Settings] File: mynote2.php, Line: 2829, Subtitle state initialized from localStorage:\', window.subtitlesVisible);
      }
