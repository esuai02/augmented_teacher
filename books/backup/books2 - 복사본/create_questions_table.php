<?php
/**
 * File: create_questions_table.php
 * Purpose: 추가 질문 답변 저장을 위한 테이블 생성
 * Location: /mnt/c/1 Project/augmented_teacher/books/create_questions_table.php
 *
...
echo '<h2>추가 질문 테이블 생성 스크립트</h2>';
echo '<pre>';

try {
    $tableName = 'abrainalignment_questions';
    ...
    if ($tableExists) {
        ...
        ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='추가 질문과 AI 답변 저장';";
