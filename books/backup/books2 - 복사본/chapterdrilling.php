...
for ($nch = 1; $nch <= $chapnum; $nch++) {
    ...
    $chapterUrl = "https://mathking.kr/moodle/local/augmented_teacher/books/chapter_topic.php"
                . "?cid={$cid2}&nch={$nchapter}&studentid={$studentid}&domain={$domain}";
...
<body>
  <div class="container">
    ...
    <div style="text-align: center; margin-top: 20px;">
      <a href="domaindrilling.php?studentid=<?php echo $studentid; ?>&domain=<?php echo $domain; ?>" class="back-to-map">그랜드 라인 항해도로 돌아가기</a>
    </div>
