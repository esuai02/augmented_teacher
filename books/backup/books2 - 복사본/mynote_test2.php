      ...
      if($cnttext->audiourl !== NULL || $cnttext->audiourl2 !== NULL) {
        ...
        <script>
          (function() {
            ...
            window.toggleListeningPlayer = function() {
              ...
              if(isMinimized) {
                ...
                if(audioPlayer2 && audioPlayer2.paused) {
                  audioPlayer2.play().catch(e => {
                    console.log("[Auto Resume] File: mynote2.php, Line: 1450, Blocked:", e);
                  });
                  console.log("[Interface] File: mynote2.php, Line: 1450, Player expanded - Auto resume audio");
                }
              } else {
                // 최소화: 자동 일시정지
                if(audioPlayer2 && !audioPlayer2.paused) {
                  audioPlayer2.pause();
                  console.log("[Interface] File: mynote2.php, Line: 1450, Player minimized - Auto pause audio");
                }
              }
            };
            ...
            // }, 500);
            console.log("[Auto Play] File: mynote2.php, Line: 1488, Auto-play disabled - user must click play button");
          })();
        </script>';
        }
      }
