...
else $todaygoal='<a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday42.php?id=1491"> 목표 입력하기 </a>';
...
$chaptertitle='<a style="font-size:20px;text-decoration:none;" href="https://mathking.kr/moodle/local/augmented_teacher/students/index42.php?id='.$studentid.'">'.$studentname.'</a> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding42.php?userid='.$studentid.'"><img style="margin-bottom:10px;" src=https://mathking.kr/Contents/IMAGES/pomodorologo.png width=40></a>';
//
for($nch=1;$nch<=$chapnum;$nch++)
{
	...
	else $chapterlist.='<tr><td>'.$nch.'</td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid='.$cid.'&nch='.$nch.'&studentid='.$studentid.'">'.$title.'</a>'.$quizresult.'</td></tr>';
	}
...
for($nch=1;$nch<=$chapnum;$nch++) 
	...
	if($cid==$cid2 && $nchapter==$chnum) 
		...
		$notetitle='<a href="https://mathking.kr/moodle/local/augmented_teacher/students/today42.php?id='.$studentid.'&tb=604800"target="_blank">'.$studentname.'</a>의 <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&cid='.$cid2.'&nch='.$nchapter.'&mode=map"target="_blank">개념집착</a> : '.$domaintitle;
...
foreach($result as $value)
	...
	if(strpos($linkurl, 'icontent')!= false)
		...
		if(strpos($displaytext, '도약')!= false )
			...
			$todoitem='&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/books/mynote42.php?dmn='.$domain.'&cid='.$cid.'&nch='.$chnum.'&cmid='.$cntid.'&page=1&studentid='.$studentid.'&quizid='.$quizid.'"><button  class="stylish-button">NEXT</button></a> ';
		...
		elseif(strpos($displaytext, '유형')!==false)
			...
			$nview=1;
			//if($thiscntid==$cntid)$classname='collapse show';
			$todoitem='<a href="https://mathking.kr/moodle/local/augmented_teacher/students/KeyPatternsGame.php?&cid='.$cid.'&cntid='.$cntid.'&studentid='.$studentid.'"><img  loading="lazy" style="margin-bottom:7px;" src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/topic.png width=20></a> <a href="https://mathking.kr/moodle/local/augmented_teacher/books/mynote42.php?dmn='.$domain.'&cid='.$cid.'&nch='.$chnum.'&cmid='.$cntid.'&page=1&studentid='.$studentid.'&quizid='.$quizid.'"><button  class="stylish-button">NEXT</button></a> &nbsp;&nbsp;&nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/books/mynote_test.php?dmn='.$domain.'&cid='.$cid.'&nch='.$chnum.'&cmid='.$cntid.'&page=1&studentid='.$studentid.'&quizid='.$quizid.'">✏ 서술평가</a> | <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/smartguide/index.php?dmn='.$domain.'&cid='.$cid.'&nch='.$chnum.'&cntid='.$cntid.'&page=1&studentid='.$studentid.'&quizid='.$quizid.'">✏ 시간조절</a>';
			}
	...
	<div class="card"  style="font-size:16;">
	  <div class="card-header" style="white-space: nowrap;">
		<input type="checkbox" name="checkAccount" onClick="addReview(\''.$thismenutext.'\')"/> <a class="'.$link_class.'" style="color:#4287f5;" data-bs-toggle="collapse" href="#collapse'.$ncolap.'"> <span style="color:black;font-size:18;">'.$displaytext.'</span></a>
	  </div>
	  <div id="collapse'.$ncolap.'" class="'.$classname.'" data-bs-parent="#accordion">
		<div class="card-body">
		 '.$scriptontopic.'
		</div>
	  </div>
	...
	elseif($nview==1)$topiclist.='
				<div class="card"  style="font-size:16;">
				  <div class="card-header" style="white-space: nowrap;">
					<input type="checkbox" name="checkAccount" '.$checkstatus.' onClick="CheckProgress(2,\''.$studentid.'\',\''.$chkitemid.'\', this.checked)"/> <a class="'.$link_class.'" style="color:#4287f5;" data-bs-toggle="collapse" href="#collapse'.$ncolap.'"> <span style="color:black;font-size:18;">'.$displaytext.'</span></a>'.$setgoal.$retrieval.$quizresult.'  
				  </div>
				  <div id="collapse'.$ncolap.'" class="'.$classname.'" data-bs-parent="#accordion">
					<div class="card-body">
...
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=73&nch=1&studentid='.$studentid.'&type=init">초등 4-1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=74&nch=1&studentid='.$studentid.'&type=init">초등 4-2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=75&nch=1&studentid='.$studentid.'&type=init">초등 5-1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=76&nch=1&studentid='.$studentid.'&type=init">초등 5-2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=78&nch=1&studentid='.$studentid.'&type=init">초등 6-1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=79&nch=1&studentid='.$studentid.'&type=init">초등 6-2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=66&nch=1&studentid='.$studentid.'&type=init">중 1-1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=67&nch=1&studentid='.$studentid.'&type=init">중 1-2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=68&nch=1&studentid='.$studentid.'&type=init">중 2-1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=69&nch=1&studentid='.$studentid.'&type=init">중 2-2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=71&nch=1&studentid='.$studentid.'&type=init">중 3-1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=72&nch=1&studentid='.$studentid.'&type=init">중 3-2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=106&nch=1&studentid='.$studentid.'&type=init">공통수학 1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=107&nch=1&studentid='.$studentid.'&type=init">공통수학 2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=59&nch=1&studentid='.$studentid.'&type=init">수 상</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=60&nch=1&studentid='.$studentid.'&type=init">수 하</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=61&nch=1&studentid='.$studentid.'&type=init">수 1</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=62&nch=1&studentid='.$studentid.'&type=init">수 2</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=64&nch=1&studentid='.$studentid.'&type=init">확통</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=63&nch=1&studentid='.$studentid.'&type=init">미적</a> |
<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modeinfo.'&cid=65&nch=1&studentid='.$studentid.'&type=init">기하</a></td></tr></table> <br> </div>';
...
<div class="demo">
  <div class="progress-card">
	...
	<div class="progress" style="background-color:#bdbdbd; height:15px;">
	  <div class="progress-bar progress-bar-striped bg-'.$bgtype.'" role="progressbar" style="width: '.$progressfilled.'%; height: 15px;" aria-valuenow="'.$progressfilled.'" aria-valuemin="0" aria-valuemax="100" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-original-title="'.$progressfilled.'%"></div>
	</div>
  </div>
</div>
</div>
...
<head>
  ...
  <link href="assets/css/chapter42.css" rel="stylesheet">
...
<body>
	...
	<div class="container">
		<div class="left-column">
			...
			<hr><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?'.$modechange.'cid='.$cid.'&nch=1&studentid='.$studentid.'&type=init "> <img style="margin-bottom:5px;" loading="lazy"  src="https://mathking.kr/Contents/IMAGES/learningpath.png" width=20>&nbsp; <span style="font-size:16px;">'.$modetext.'</span></a> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic42.php?id='.$USER->id.'&userid='.$studentid.'"><img style="margin-bottom:10px;" src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png width=40></a><br><br>'.$domchapters.' 
			</div>
		</div>
...
<button id="diary" class="swal2-confirm swal2-styled" style="margin:5px; font-size:20px;">수학일기</button>
        ...
        didOpen: () => {
            ...
            weeklyGoalBtn.addEventListener("click", () => {
                Swal.close();
                window.open("https://mathking.kr/moodle/local/augmented_teacher/students/edittoday42.php?id=" + Userid + "&cntinput=" + Inputtext + "&gtype=%EC%A3%BC%EA%B0%84%EB%AA%A9%ED%91%9C");
            
            });

            todayGoalBtn.addEventListener("click", () => {
                Swal.close();
                window.open("https://mathking.kr/moodle/local/augmented_teacher/students/edittoday42.php?id=" + Userid + "&cntinput=" + Inputtext);
                
            });

            diaryBtn.addEventListener("click", () => {
                Swal.close();
                window.open("https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding42.php?userid=" + Userid + "&cntinput=" + Inputtext);
