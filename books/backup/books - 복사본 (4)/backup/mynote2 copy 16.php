    ...
    if($cnttext->audiourl !== NULL || $cnttext->audiourl2 !== NULL) {
      ...
      if($cnttext->audiourl2 !== NULL) {
        ...
        if($isListeningTest && $sectionData) {
          ...
          <script>
            // 재생 속도 순환 함수 (1.0x → 1.25x → 1.5x → 1.75x → 2.0x → 1.0x)
            ...
            function cyclePlaybackSpeed() {
              ...
              if (!audioPlayer || !speedBtn) {
                console.error("[Speed Control] File: mynote2.php, Line: 703, Elements not found");
                return;
              }
              ...
              console.log("[Speed Control] File: mynote2.php, Line: 718, Speed changed to:", newSpeed);
            }
            ...
            (function() {
              ...
              function switchToSection(newSection) {
                ...
                audioPlayer2.addEventListener("loadeddata", function playNext() {
                  audioPlayer2.play().catch(e => console.error("[Audio Error] File: mynote2.php, Line: 972, Error:", e));
