-- 테이블을 완전히 재생성하는 SQL (기존 데이터가 없거나 초기화해도 되는 경우)
...
-- 기존 테이블이 있으면 백업
RENAME TABLE mdl_alt42i_math_patterns TO mdl_alt42i_math_patterns_old;
RENAME TABLE mdl_alt42i_pattern_solutions TO mdl_alt42i_pattern_solutions_old;

-- ========================================
-- 2. 카테고리 테이블 생성 (필요한 경우)
-- ========================================
...
-- ========================================
-- 3. 새 테이블 생성 (INSERT SQL과 일치하는 구조)
-- ========================================
...
-- ========================================
-- 5. 이제 insert_personas_1_to_10.sql과 insert_personas_11_to_60.sql을 실행할 수 있습니다
-- ========================================