...
아래 '나의 풀이 메시지함'에서 상세한 설명을 확인하세요!`;
                    ...
                    <div class="history-item" data-id="${item.id}" style="display: flex; gap: 15px; background: ${bgColor}; border: 2px solid ${borderColor};">
                        ...
                        <div class="history-item-actions" style="display: flex; flex-direction: column; gap: 6px; min-width: 280px; max-width: 280px;">
                            ...
                            <button class="btn btn-sm" 
                                    onclick="openSolutionStyleModal(${item.id}, '${item.problemImage || ''}', ${isReRequest})"
        ...
        // 풀이 스타일 선택 팝업 열기
        function openSolutionStyleModal(interactionId, problemImage, isReRequest = false) {
            console.log('[openSolutionStyleModal] 호출:', { interactionId, problemImage, isReRequest });
        ...
        function selectSolutionStyle(style) {
            ...
            if (style === 'default') {
                acceptNewRequest(solutionStyleData.interactionId, solutionStyleData.problemImage, solutionStyleData.isReRequest);
            } else {
                acceptNewRequestWithStyle(solutionStyleData.interactionId, solutionStyleData.problemImage, solutionStyleData.isReRequest, style);
            }
        }
        ...
        function openCustomSolutionFromStyleModal() {
            closeSolutionStyleModal();
            openCustomSolutionModal(solutionStyleData.interactionId, solutionStyleData.problemImage, solutionStyleData.isReRequest);
        }
