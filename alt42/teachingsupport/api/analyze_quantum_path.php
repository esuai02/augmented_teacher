...
function getDefaultMazeData() {
    return [
        ...
        // 좌표는 JS useDefaultMaze()와 동기화됨 (SVG viewBox: 650x560)
        'nodes' => [
            // Stage 0 - 시작
            'start' => ['id' => 'start', 'x' => 350, 'y' => 40, 'label' => '문제 인식', 'type' => 'start', 'stage' => 0, 'concepts' => []],
            // Stage 1 - 문제 해석
            ...
            // Stage 2 - 접근 방법
            's2_c1' => ['id' => 's2_c1', 'x' => 100, 'y' => 220, 'label' => 'f(x)>g(x)', 'type' => 'correct', 'stage' => 2, 'concepts' => ['inequality', 'comparison']],
            's2_c2' => ['id' => 's2_c2', 'x' => 250, 'y' => 220, 'label' => '그래프 접근', 'type' => 'partial', 'stage' => 2, 'concepts' => ['graph', 'comparison']],
            's2_m1' => ['id' => 's2_m1', 'x' => 400, 'y' => 220, 'label' => 'f(x)<g(x)', 'type' => 'wrong', 'stage' => 2, 'concepts' => ['inequality']],
            's2_m2' => ['id' => 's2_m2', 'x' => 520, 'y' => 220, 'label' => 'f(x)=g(x)', 'type' => 'wrong', 'stage' => 2, 'concepts' => ['roots']],
            's2_x1' => ['id' => 's2_x1', 'x' => 620, 'y' => 220, 'label' => '막막함', 'type' => 'confused', 'stage' => 2, 'concepts' => []],
            // Stage 3 - 식 정리
            's3_c' => ['id' => 's3_c', 'x' => 120, 'y' => 320, 'label' => 'x²-3x-10>0', 'type' => 'correct', 'stage' => 3, 'concepts' => ['transpose', 'inequality']],
            's3_p' => ['id' => 's3_p', 'x' => 280, 'y' => 320, 'label' => '시각적 정리', 'type' => 'partial', 'stage' => 3, 'concepts' => ['graph', 'transpose']],
            's3_m1' => ['id' => 's3_m1', 'x' => 450, 'y' => 320, 'label' => '부호 오류', 'type' => 'wrong', 'stage' => 3, 'concepts' => ['transpose']],
            's3_m2' => ['id' => 's3_m2', 'x' => 580, 'y' => 320, 'label' => '등식만 품', 'type' => 'wrong', 'stage' => 3, 'concepts' => ['factorize', 'roots']],
            // Stage 4 - 근 찾기
            's4_c' => ['id' => 's4_c', 'x' => 140, 'y' => 420, 'label' => 'x=-2, 5', 'type' => 'correct', 'stage' => 4, 'concepts' => ['factorize', 'roots']],
            's4_p' => ['id' => 's4_p', 'x' => 300, 'y' => 420, 'label' => '그래프 추정', 'type' => 'partial', 'stage' => 4, 'concepts' => ['graph', 'roots']],
            's4_m' => ['id' => 's4_m', 'x' => 460, 'y' => 420, 'label' => '근만 구함', 'type' => 'wrong', 'stage' => 4, 'concepts' => ['factorize', 'roots']],
            's4_m2' => ['id' => 's4_m2', 'x' => 580, 'y' => 420, 'label' => '잘못된 근', 'type' => 'wrong', 'stage' => 4, 'concepts' => ['roots']],
            // Stage 5 - 최종 결과
            'success' => ['id' => 'success', 'x' => 140, 'y' => 520, 'label' => '💥 x<-2, x>5', 'type' => 'success', 'stage' => 5, 'concepts' => ['sign', 'interval']],
            'partial_s' => ['id' => 'partial_s', 'x' => 300, 'y' => 520, 'label' => '✨ 정답', 'type' => 'success', 'stage' => 5, 'concepts' => ['graph', 'interval']],
            'fail_m1' => ['id' => 'fail_m1', 'x' => 460, 'y' => 520, 'label' => '❌ -2<x<5', 'type' => 'fail', 'stage' => 5, 'concepts' => ['sign', 'interval']],
            'fail_m2' => ['id' => 'fail_m2', 'x' => 580, 'y' => 520, 'label' => '❌ 오답', 'type' => 'fail', 'stage' => 5, 'concepts' => ['interval']],
        ],
        'edges' => [
