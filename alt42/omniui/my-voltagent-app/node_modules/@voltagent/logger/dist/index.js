...
__export(index_exports, {
  InMemoryLogBuffer: () => InMemoryLogBuffer,
  PinoLoggerProvider: () => PinoLoggerProvider,
  connectExternalLogBuffer: () => connectExternalLogBuffer,
  createPinoLogger: () => createPinoLogger,
  getDefaultLogFormat: () => getDefaultLogFormat,
  getDefaultLogLevel: () => getDefaultLogLevel,
  getDefaultRedactionPaths: () => getDefaultRedactionPaths,
  getGlobalLogBuffer: () => getGlobalLogBuffer,
  getGlobalLoggerProvider: () => getGlobalLoggerProvider,
  setGlobalLoggerProvider: () => setGlobalLoggerProvider
});
...
var PinoLoggerProvider = class {
  ...
  createLogger(options) {
    ...
    const pinoInstance = (0, import_pino.default)(pinoOptions);
  ...
  createPinoOptions(options = {}) {
    ...
    const pinoOptions = {
      ...
      serializers: {
        ...
        exception: import_pino.default.stdSerializers.err
      },
      formatters: {
