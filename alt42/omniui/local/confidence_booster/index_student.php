...
<body>
    <div class="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div class="glass p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div class="bg-purple-50 p-4 rounded-lg">
                    <h3 class="font-bold text-purple-800 mb-3">📝 오늘 꼭 할 일</h3>
                    <div id="todayTasks" class="space-y-2">
                        <div class="flex items-center">
                            <input type="checkbox" class="mr-2" id="task1">
                            <label for="task1">수학 문제집 10문제 풀기</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" class="mr-2" id="task2">
                            <label for="task2">오늘 배운 내용 요약하기</label>
                        </div>
                        <div class="flex items-center">
                            <input type="checkbox" class="mr-2" id="task3">
                            <label for="task3">틀린 문제 오답노트 작성</label>
                        </div>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-8">
            ...
            <div class="glass p-6 bg-gradient-to-br from-purple-100 to-pink-100">
                <h3 class="text-lg font-bold mb-3 gradient-text">💡 오늘의 학습 팁</h3>
                <div class="space-y-3">
                    <?php if ($exam_phase === 'finish'): ?>
                    <p class="text-sm">🔥 시험이 얼마 남지 않았어요!</p>
                    <ul class="text-sm space-y-1">
                        <li>• 오답노트 집중 복습</li>
                        <li>• 취약 단원 마지막 점검</li>
                        <li>• 충분한 휴식과 컨디션 관리</li>
                    </ul>
                    <?php elseif ($exam_phase === 'intensive'): ?>
                    <p class="text-sm">📚 집중 학습 기간입니다!</p>
                    <ul class="text-sm space-y-1">
                        <li>• 매일 문제 풀이 연습</li>
                        <li>• 오답 패턴 분석</li>
                        <li>• 시간 배분 연습</li>
                    ...
                    <?php else: ?>
                    <p class="text-sm">🌱 꾸준한 학습이 중요해요!</p>
                    <ul class="text-sm space-y-1">
                        <li>• 매일 조금씩 복습하기</li>
                        <li>• 개념 이해에 집중</li>
                        <li>• 요약 노트 만들기</li>
    ...
    // 체크리스트 저장 (로컬)
    document.querySelectorAll('#todayTasks input[type="checkbox"]').forEach(checkbox => {
