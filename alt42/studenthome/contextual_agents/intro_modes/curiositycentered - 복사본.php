...
<body>
    ...
    <div class="scene" id="scene4">
        <div class="chapter-title">Chapter 3. 탐구 컴퍼스</div>
        <div class="typing-text" id="compass-text"></div>
        <div class="compass-nav" id="compass-nav"></div>
        <button class="next-btn" id="btn4" disabled onclick="nextScene(5)">탐구 시작하기</button>
    </div>
    
    <!-- Scene 5: 학습 철학 -->
    <div class="scene" id="scene5">
        <div class="chapter-title">Chapter 4. 우리의 약속</div>
        <div class="special-card">
            <div class="typing-text" id="philosophy-text"></div>
        </div>
        <button class="next-btn" id="btn5" disabled onclick="nextScene(6)">동의하고 시작하기</button>
    </div>
    ...
    <div class="scene" id="scene6">
        ...
        <button class="next-btn pulse" id="btn6" disabled onclick="startJourney()">
            🚀 탐구 여정 시작하기
        </button>
    </div>
    ...
    <script>
        ...
        function showCompassItems() {
            const items = [
                { title: "개념 탐구", desc: "근본적인 원리 파헤치기" },
                { title: "연결 발견", desc: "다른 분야와의 관계 찾기" },
                { title: "실생활 적용", desc: "일상 속 수학 발견하기" },
                { title: "역사 여행", desc: "수학사 속 이야기 탐험" }
            ];
