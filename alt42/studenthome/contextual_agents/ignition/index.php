...
<body>
    ...
    <div class="container">
        ...
        <div class="goal-setting" id="goalSetting">
            ...
            <div class="goals-container">
                ...
                <div class="goal-section <?php echo $needTermPlan ? 'empty' : ''; ?>" id="termGoalSection">
                    ...
                    <div class="goal-content-editable" onclick="startInlineEdit('term')" id="termGoalContent">
                        ...
                        <?php else: ?>
                            <span class="empty-message">분기 목표 입력</span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="goal-section <?php echo $needWeeklyGoal ? 'empty' : ''; ?>" id="weeklyGoalSection">
                    ...
                    <div class="goal-content-editable" onclick="startInlineEdit('weekly')" id="weeklyGoalContent">
                        ...
                        <?php else: ?>
                            <span class="empty-message">주간 목표 입력</span>
                        <?php endif; ?>
                    </div>
                ...
                <div class="goal-section <?php echo $needTodayGoal ? 'empty' : ''; ?>" id="todayGoalSection">
                    ...
                    <div class="goal-content-editable" onclick="startInlineEdit('today')" id="todayGoalContent">
                        ...
                        <?php else: ?>
                            <span class="empty-message">오늘 목표 입력</span>
                        <?php endif; ?>
                    </div>
            ...
            <div class="timer-container">
                ...
                <div class="timer-text" id="timerText">자동으로 다음 단계로 진행합니다...</div>
            </div>
    ...
    <script>
        ...
        function startAutoProgressTimer() {
            ...
            let timeLeft = 30000; // 10초 (밀리초)
            const interval = 100; // 100ms마다 업데이트
            let elapsed = 0;
            
            const timer = setInterval(() => {
                elapsed += interval;
                const progress = (elapsed / timeLeft) * 100;
                timerProgress.style.width = progress + '%';
                
                const secondsLeft = Math.ceil((timeLeft - elapsed) / 1000);
                timerText.textContent = `자동으로 다음 단계로 진행합니다... (${secondsLeft}초)`;
