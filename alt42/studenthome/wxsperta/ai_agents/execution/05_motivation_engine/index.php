<?php
/**
 * Q-MIND: 에너지 충전 (Motivation Engine)
 */
...
<body>
    <div class="quantum-container">
        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"오늘 내 에너지는 몇 퍼센트? 열정 게이지를 확인하고 충전하세요!"</p>
                </div>
                        </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">지금</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">충전 중</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">에너지 UP</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 풀 충전</span></div>
                            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 에너지가 가득 찼을 때 어떤 감정을 느끼고 싶나요?</p>
                <div class="emotion-selector">
                    <button class="emotion-btn" data-emotion="thrilled" data-color="#ff4081"><span class="emoji">⚡</span> 짜릿함</button>
                    <button class="emotion-btn" data-emotion="relieved" data-color="#00e676"><span class="emoji">😌</span> 평화로움</button>
                    <button class="emotion-btn" data-emotion="confident" data-color="#00e5ff"><span class="emoji">💪</span> 활력</button>
                    <button class="emotion-btn" data-emotion="proud" data-color="#b388ff"><span class="emoji">🔥</span> 열정</button>
                            </div>
                        </div>
        </section>
        ...
        <section id="fluctuation" class="quantum-section">
            <div class="section-header">
                <div class="section-icon">⚡</div>
                <div><h2 class="section-title">양자 요동 모니터</h2><p class="section-subtitle">"에너지 요동이 클수록 터널링 확률 상승"</p></div>
                            </div>
            ...
            <div class="entangled-agents">
                <?php foreach ($entangled_agents as $ea): 
                    ...
                    switch($ea['category']) {
                        ...
                        case 'execution': $path = "../{$ea['id']}/index.php"; break;
