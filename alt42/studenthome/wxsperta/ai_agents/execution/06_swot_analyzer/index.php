        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"나의 숨겨진 강점을 발견하고, 약점도 인정해봐요. 아는 게 힘!"</p>
                </div>
                        </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">분석 시작</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">강점 발견</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">약점 인정</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 자기 이해</span></div>
                            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 나를 완전히 이해했을 때 어떤 감정을 느끼고 싶나요?</p>
