        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"한 주가 어땠어? 관제탑과 함께 되돌아보고 다음 주를 준비해봐."</p>
                </div>
            </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">이번 주</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">리뷰</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">계획</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 다음 주</span></div>
            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 완벽한 주간 리뷰를 마쳤을 때 어떤 감정을 느끼고 싶나요?</p>
                <div class="emotion-selector">
                    <button class="emotion-btn" data-emotion="thrilled" data-color="#ff4081"><span class="emoji">🗼</span> 통제감</button>
                    ...
                    <button class="emotion-btn" data-emotion="proud" data-color="#b388ff"><span class="emoji">📊</span> 성장함</button>
                </div>
            </div>
        </section>
