<?php
/**
 * Q-MIND: 자동 시스템 (Flexible Backbone)
 */
        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"나만의 시스템을 만들어서 자동으로 굴러가게 해봐. 습관의 힘!"</p>
                </div>
            </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">의식적</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">반복</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">습관화</span></div>
            ...
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 모든 것이 자동으로 굴러갈 때 어떤 감정을 느끼고 싶나요?</p>
                <div class="emotion-selector">
                    <button class="emotion-btn" data-emotion="thrilled" data-color="#ff4081"><span class="emoji">⚙️</span> 해방감</button>
                    ...
                    <button class="emotion-btn" data-emotion="proud" data-color="#b388ff"><span class="emoji">🔄</span> 통제감</button>
                </div>
            </div>
        </section>
