        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"관심 있는 정보가 자동으로 내 위성에 도착하도록 세팅해봐!"</p>
                </div>
            </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">검색</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">필터링</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">수신</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 자동 수신</span></div>
            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 원하는 정보가 자동으로 도착할 때 어떤 감정을 느끼고 싶나요?</p>
                <div class="emotion-selector">
                    <button class="emotion-btn" data-emotion="thrilled" data-color="#ff4081"><span class="emoji">📡</span> 연결됨</button>
                    <button class="emotion-btn" data-emotion="relieved" data-color="#00e676"><span class="emoji">😌</span> 편안함</button>
                    <button class="emotion-btn" data-emotion="confident" data-color="#00e5ff"><span class="emoji">💪</span> 앞서감</button>
                    <button class="emotion-btn" data-emotion="proud" data-color="#b388ff"><span class="emoji">🌐</span> 정보력</button>
                </div>
            </div>
        </section>
