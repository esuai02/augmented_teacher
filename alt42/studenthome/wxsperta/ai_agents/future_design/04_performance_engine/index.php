<?php
/**
 * Q-MIND: 별자리 만들기 (Performance Engine)
 * 양자 학습 모델 기반 목표 연결
 */
        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"목표를 별로 찍고 연결해서 나만의 별자리를 만들어봐!"</p>
                </div>
                        </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">첫 번째 별</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">연결</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">형태</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 별자리</span></div>
                            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 나만의 별자리가 완성되었을 때 어떤 감정을 느끼고 싶나요?</p>
