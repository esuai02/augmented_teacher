        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"과거의 나와 비교하면 놀랄걸!" - 얼마나 날아왔는지 기록하세요</p>
                </div>
                        </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">시작점</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">성장 중</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">도약</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 마스터</span></div>
                            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 성장을 확인했을 때 어떤 감정을 느끼고 싶나요?</p>
