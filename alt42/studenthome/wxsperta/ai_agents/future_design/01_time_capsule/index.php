<?php
/**
 * Q-MIND: 미래 통신 (Time Capsule)
 * 양자 학습 모델 기반 미래 비전 설계
 */
    ...
    <div class="quantum-container">
        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"미래가 현재를 끌어당긴다" - 미래의 나에게 메시지를 보내세요</p>
                </div>
            </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">현재</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">1년 후</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">5년 후</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 미래의 나</span></div>
            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 미래의 나로부터 답장을 받았을 때 어떤 감정을 느끼고 싶나요?</p>
                <div class="emotion-selector">
                    <button class="emotion-btn" data-emotion="thrilled" data-color="#ff4081"><span class="emoji">⚡</span> 짜릿함</button>
                    <button class="emotion-btn" data-emotion="relieved" data-color="#00e676"><span class="emoji">😌</span> 안도감</button>
                    <button class="emotion-btn" data-emotion="confident" data-color="#00e5ff"><span class="emoji">💪</span> 자신감</button>
        ...
        <section id="fluctuation" class="quantum-section">
            <div class="section-header">
                <div class="section-icon">⚡</div>
                <div>
                    <h2 class="section-title">양자 요동 모니터</h2>
                    <p class="section-subtitle">"헤매임은 터널링을 위한 에너지"</p>
                        </div>
                            </div>
        ...
        <section id="tunneling" class="quantum-section">
            <div class="section-header">
                <div class="section-icon">🔮</div>
                <div>
                    <h2 class="section-title">터널링 인젝션</h2>
                    <p class="section-subtitle">"논리를 우회하면 장벽을 뚫을 수 있다"</p>
                            </div>
                            </div>
        ...
        <section id="projects" class="quantum-section projects-section">
            <div class="section-header">
                <div class="section-icon">📋</div>
                <div>
                    <h2 class="section-title"><?php echo htmlspecialchars($current_agent['name']); ?> 프로젝트</h2>
                    <p class="section-subtitle">모든 작업 완료 시 파동함수가 붕괴합니다</p>
                        </div>
                    </div>
        ...
        <section id="entanglement" class="quantum-section">
            <div class="section-header">
                <div class="section-icon">🔗</div>
                <div>
                    <h2 class="section-title">양자 얽힘 네트워크</h2>
                    <p class="section-subtitle">"얽힌 에이전트들은 즉시 상호 영향을 받습니다"</p>
                </div>
            </div>
            <div class="entangled-agents">
                <?php foreach ($entangled_agents as $ea): 
                    $path = '';
                    switch($ea['category']) {
                        case 'future_design': $path = "../{$ea['id']}/index.php"; break;
                        case 'execution': $path = "../../execution/{$ea['id']}/index.php"; break;
                        case 'branding': $path = "../../branding/{$ea['id']}/index.php"; break;
                        case 'knowledge_management': $path = "../../knowledge_management/{$ea['id']}/index.php"; break;
                    }
                ?>
        ...
        <footer class="quantum-footer">
            ...
            <p style="margin-top: 0.5rem; opacity: 0.7;">© 2024 AI 에이전트 프로젝트</p>
        </footer>
    </div>
