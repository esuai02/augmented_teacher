<?php
/**
 * Q-MIND: 항로 설계 (Timeline Synthesizer)
 * 양자 학습 모델 기반 목표 여정 설계
 */
...
<body>
    <div class="quantum-container">
        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"목표까지의 여정을 그려라" - 큰 목표를 작은 스텝으로 나눠서 하나씩 클리어!</p>
                </div>
                        </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">출발점</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">첫 마일스톤</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">중간 지점</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 목적지</span></div>
                            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 목표를 달성했을 때 어떤 감정을 느끼고 싶나요?</p>
        ...
        <section id="tunneling" class="quantum-section">
            <div class="section-header">
                <div class="section-icon">🔮</div>
                <div><h2 class="section-title">터널링 인젝션</h2><p class="section-subtitle">"논리를 우회하면 장벽을 뚫을 수 있다"</p></div>
                    </div>
        ...
        <section id="entanglement" class="quantum-section">
            <div class="section-header">
                <div class="section-icon">🔗</div>
                <div><h2 class="section-title">양자 얽힘 네트워크</h2><p class="section-subtitle">"얽힌 에이전트들은 즉시 상호 영향을 받습니다"</p></div>
            </div>
