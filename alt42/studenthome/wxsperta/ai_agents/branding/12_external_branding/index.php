<?php
/**
 * Q-MIND: 신호 발사 (External Branding)
 */
        ...
        <section id="future-anchor" class="quantum-section">
            <div class="section-header">
                ...
                <div>
                    ...
                    <p class="section-subtitle">"나만의 신호를 우주에 발사해봐요. SNS, 포트폴리오로 나를 알리는 방법!"</p>
                </div>
                        </div>
            <div class="reverse-timeline">
                <div class="timeline-node current"><div class="timeline-dot"></div><span class="timeline-label">준비</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">제작</span></div>
                <div class="timeline-node"><div class="timeline-dot"></div><span class="timeline-label">발사</span></div>
                <div class="timeline-node future"><div class="timeline-dot"></div><span class="timeline-label">✨ 도달</span></div>
                            </div>
            <div class="future-memory-generator">
                <p class="memory-prompt">💭 내 신호가 세상에 도달했을 때 어떤 감정을 느끼고 싶나요?</p>
                <div class="emotion-selector">
                    <button class="emotion-btn" data-emotion="thrilled" data-color="#ff4081"><span class="emoji">📢</span> 짜릿함</button>
                    <button class="emotion-btn" data-emotion="relieved" data-color="#00e676"><span class="emoji">😌</span> 연결됨</button>
                    <button class="emotion-btn" data-emotion="confident" data-color="#00e5ff"><span class="emoji">💪</span> 인정받음</button>
