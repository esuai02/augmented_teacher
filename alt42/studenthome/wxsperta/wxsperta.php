    ...
    <div id="mainContainer" class="main-container">
        <div class="orbit-container">
            ...
            <div class="view-switcher" style="position: absolute; top: 1rem; left: 1rem; display: flex; gap: 0.5rem; padding: 0.25rem; background: rgba(255,255,255,0.08); border-radius: 12px; border: 1px solid rgba(255,255,255,0.15); backdrop-filter: blur(10px);">
                <!-- 학생 메인 동작(대화)을 가장 앞에 -->
                <button id="globalChatBtn" class="view-btn" onclick="openGlobalMentorChat()" title="전체 멘토링 대화">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M20 2H4a2 2 0 0 0-2 2v17l4-3h14a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2z"/></svg>
                </button>
                ...
                <!-- 고급(상태/흐름) 느낌은 마지막에 -->
                <button id="neuronBtn" class="view-btn" onclick="openWXSPERTANeuron()" title="내 성장 조각(상태+흐름)">
                    <span style="font-size: 0.8rem; font-weight: 700; letter-spacing: 0.04em;">WX</span>
                </button>
            </div>
