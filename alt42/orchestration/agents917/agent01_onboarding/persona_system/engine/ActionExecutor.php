...
class ActionExecutor {
    ...
    private function registerDefaultHandlers(): void {
        ...
        $this->handlers['set_tone'] = function($value, $context) {
            $validTones = ['Professional', 'Warm', 'Encouraging', 'Calm', 'Playful', 'Direct', 'Empathetic'];
        ...
        $this->handlers['set_response_style'] = function($value, $context) {
            $validStyles = ['concise', 'detailed', 'structured', 'conversational', 'technical'];
 ...
 * - set_tone: 톤 설정 (Professional, Warm, Encouraging, Calm, Playful, Direct, Empathetic)
 * - set_pace: 페이스 설정 (slow, normal, fast, adaptive)
 ...
 * - add_flag: 플래그 추가
 * - set_response_style: 응답 스타일 (concise, detailed, structured, conversational, technical)
