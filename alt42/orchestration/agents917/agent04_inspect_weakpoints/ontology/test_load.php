 ...
 * File: alt42/orchestration/agents/agent04_inspect_weakpoints/ontology/test_load.php
 * 
...
<head>
    <meta charset="utf-8">
    <title>Agent04 OntologyActionHandler 로드 테스트</title>
    <style>
...
<body>
    <div class="container">
        <h1>🧪 Agent04 OntologyActionHandler.php 로드 테스트</h1>
        ...
        try {
            // OntologyActionHandler 인스턴스 생성 (Agent04는 생성자 시그니처가 다름)
            $testContext = [
        ...
        echo "이 파일은 다른 PHP 파일에서 <code>require_once()</code>로 로드되어 사용됩니다.<br>";
        echo "</div>";
        ?>
    </div>
</body>
