<?php
/**
 * 온톨로지 추론 실험실 (Inference Lab)
 *
 * 목적: 실시간으로 추론 실험을 수행할 수 있는 대화형 인터페이스
 * 경로: https://mathking.kr/moodle/local/augmented_teacher/alt42/ontology_brain/inference_lab.php
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    if ($_POST['action'] === 'infer') {
        ...
        // Python 스크립트 생성
        $scriptContent = generateInferenceScript($student, $emotion);
...
function generateInferenceScript($student, $emotion) {
    return <<<PYTHON
#!/usr/bin/env python3
import json
...
rules = [
    {
        "condition": {"emotion": "좌절"},
        "conclusion": "격려 필요"
    },
    {
        "condition": {"emotion": "집중"},
        "conclusion": "학습 진행"
    },
    {
        "condition": {"emotion": "피로"},
        "conclusion": "휴식 필요"
    }
]
...
<div class="container">
    <div class="header">
        <h1>🧠 온톨로지 추론 실험실</h1>
        <p>Mathking 자동개입 v1.0 - Interactive Inference Lab</p>
    </div>
