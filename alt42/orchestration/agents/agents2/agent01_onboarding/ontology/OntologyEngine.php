<?php
/**
 * Agent01 온톨로지 엔진 (프로파일 기반 공용 엔진)
 * File: agent01_onboarding/ontology/OntologyEngine.php
 * 
 * 체크포인트 2: Agent01 엔진을 프로파일 기반 공용 엔진으로 리팩토링
 * 
 * 아키텍처: 
 * ┌─────────────────────────────────────────────────────────┐
 * │                    OntologyEngine                       │
...
class OntologyEngine {
    ...
    public function __construct(bool $enableSchemaValidation = true) {
        ...
        try {
            ...
            error_log("[OntologyEngine] SchemaLoader 초기화 완료");
        } catch (Exception $e) {
            error_log("[OntologyEngine] SchemaLoader 초기화 실패: " . $e->getMessage());
