...
// 이곳에 오늘 평가 내용 추가 mdl_abessi_today 테이블에 오늘 평가 내용 추가 reflection2에 길을 잃음, 산만함, 성실함, 매우 성실, 열정적 을 팝업에서 고르게 해주세요. 결과 값은 1 ~ 5로 입력하도록 해주세요. 팝업을 선택하고 값을 DB에 insert하도록 해주세요.
