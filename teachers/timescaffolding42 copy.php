            ...
            <div class="nav-top">
                <div class="content-container"> 
                    <div class="nav-controls">
                        <div class="header-nav"><table><tr><td>
                            <a href="../students/index42.php?id='.$studentid.'" class="nav-btn">
                                <i class="fas fa-home"></i> 내공부방
                            </a></td><td>&nbsp; </td><td>
                            <a href="../students/today42.php?id='.$studentid.'&tb=604800" class="nav-btn active">
                            ...
                            <a href="../students/goals42.php?id='.$studentid.'" class="nav-btn">
                                <i class="fas fa-target"></i> 목표설정
                            </a></td><td>&nbsp; </td><td>
                            <a href="../students/schedule42.php?id='.$studentid.'&eid=1&nweek=12" class="nav-btn">
