...
foreach($result as $value) 
    ...
    if(strpos($thisuser->firstname,$tsymbol) !== false || strpos($thisuser->firstname,$tsymbol1) !== false || strpos($thisuser->firstname,$tsymbol2) !== false || strpos($thisuser->firstname,$tsymbol3) !== false)
		...
		else $todoinfo='<div class="tooltip3"><a style="font-size:16px; text-decoration:none;" href="https://chat.openai.com/g/g-UKTVcUmFc-cinjeolhan-suhag-seonsaengnim"target="_blank">친절한 수학선생님에게 질문하기</a><div> <span class="tooltiptext3"><table><tr><td><img src='.$imgSrc.' width=100%></td></tr></table></span></div> <img src='.$imgSrc.' width=30%>  '.$tpassed;
...
echo '<br><table align=center><tr><td>이미지를 복사하여 GPT 채팅창에 입력하면 설명을 볼 수 있습니다. 활동을 완료한 후 선생님에게 점검을 받아 주세요</td><td></td><td><hr></td></tr><tr><td><hr></td><td><hr></td><td><hr></td></tr></table><table align=center width=90%>'.$papertest1.'<tr><td><br></td><td><br></td><td><br></td><td><br></td></tr>'.$papertest2.'</table>';
