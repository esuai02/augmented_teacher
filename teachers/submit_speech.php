...
$reflections='';
echo '<br><br><br><table align=center width=90% class="scale-to-fit"><tr><td width=5%></td><td align=center>('.$stdname.'&nbsp;'.date("Y/m/d").')  &nbsp;&nbsp; '.$deadline.'까지 제출해 주세요.</td><td width=10%> </td></tr></table><hr><table align=center width=90% class="scale-to-fit"><tr><td width=5%></td><td align=center style="font-size:30;">발표평가가 출제되었습니다. 발표용 컴퓨터로 이동해 주세요.</td><td width=10%> </td></tr></table>
<table width=100% align=center><tr><td><hr></td><td><hr></td><td><hr></td></tr><tr><td width=10%></td><td align=center><img style="max-height: 950px; max-width: 100%; object-fit: contain;" loading="lazy" src="'.$imgSrc.'" width=500"></td><td width=10%></td></tr><tr><td width=10% valign=top></td><td>'.$reflections.'</td><td></td></tr></table><table align=center><tr><td align=center><a style="font-size:16px; text-decoration:none;" href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_record.php?id='.$wboardid.'&contentsid='.$contentsid.'&contentstype=2"target="_blank"><img src=https://www.mathking.kr/moodle/local/augmented_teacher/IMAGES/mic.png width=100></a><hr>발표시작</td></tr></table>';
