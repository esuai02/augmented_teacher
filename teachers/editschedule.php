...
$eid = $_GET["eid"];
$timecreated=time();
$DB->execute("INSERT INTO {abessi_missionlog} (userid,page,timecreated) VALUES('$teacherid','editschedule','$timecreated')");

$myteacherid=$indic->teacherid;
 echo ' 
						...
						<div class="col-md-12">
							...
							<div class="card">
								<div class="card-header">
									<div class="card-title">시간표 변경하기  (<a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/time_accupancy.php?id='.$myteacherid.'&tb=7">시간대별 사용자 수 보기</a>) </div>
								</div>
...
if($role!=='student')
	...
	$superintelligence='<tr><td>공부법</td><td><input type="text" class="form-control" id="timepicker11" value="'.$start11.'"></td><td><input type="text" class="form-control" id="timepicker12" value="'.$start12.'"></td><td><input type="text" class="form-control" id="timepicker13" value="'.$start13.'"></td><td><input type="text" class="form-control" id="timepicker14" value="'.$start14.'"></td><td><input type="text" class="form-control" id="timepicker15" value="'.$start15.'"></td><td><input type="text" class="form-control" id="timepicker16" value="'.$start16.'"></td><td><input type="text" class="form-control" id="timepicker17" value="'.$start17.'"></td></tr>';
	$savebutton='<button type="button" onclick="editschedule(3,'.$teacherid.',$(\'#timepicker1\').val(),$(\'#timepicker2\').val(),$(\'#timepicker3\').val(),$(\'#timepicker4\').val(),$(\'#timepicker5\').val(),$(\'#timepicker6\').val(),$(\'#timepicker7\').val(),$(\'#basic1\').val(),$(\'#basic2\').val(),$(\'#basic3\').val(),$(\'#basic4\').val(),$(\'#basic5\').val(),$(\'#basic6\').val(),$(\'#basic7\').val(),$(\'squareInput11\').val(),$(\'squareInput12\').val(),$(\'squareInput13\').val(),$(\'squareInput14\').val(),$(\'squareInput15\').val(),$(\'squareInput16\').val(),$(\'squareInput17\').val(),$(\'#squareInput1\').val(),$(\'#squareInput2\').val(),$(\'#squareInput3\').val(),$(\'#squareInput4\').val(),$(\'#squareInput5\').val(),$(\'#squareInput6\').val(),$(\'#squareInput7\').val(),$(\'#squareInput8\').val(),$(\'#squareInput9\').val(),$(\'#datepicker\').val(),$(\'#timepicker11\').val(),$(\'#timepicker12\').val(),$(\'#timepicker13\').val(),$(\'#timepicker14\').val(),$(\'#timepicker15\').val(),$(\'#timepicker16\').val(),$(\'#timepicker17\').val())"><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/schedule.php?id='.$teacherid.'&eid=1&nweek=4"><img src="http://mathking.kr/Contents/Moodle/save.gif" width=30></button>';
	}
else 
	{
	$superintelligence='<tr><td>공부법</td><td>'.$start11.'</td><td>'.$start12.'</td><td>'.$start13.'</td><td>'.$start14.'</td><td>'.$start15.'</td><td>'.$start16.'</td><td>'.$start17.'</td></tr>';
	$savebutton='<button type="button" onclick="editschedule2(7128,'.$teacherid.',$(\'#timepicker1\').val(),$(\'#timepicker2\').val(),$(\'#timepicker3\').val(),$(\'#timepicker4\').val(),$(\'#timepicker5\').val(),$(\'#timepicker6\').val(),$(\'#timepicker7\').val(),$(\'#basic1\').val(),$(\'#basic2\').val(),$(\'#basic3\').val(),$(\'#basic4\').val(),$(\'#basic5\').val(),$(\'#basic6\').val(),$(\'#basic7\').val(),$(\'squareInput11\').val(),$(\'squareInput12\').val(),$(\'squareInput13\').val(),$(\'squareInput14\').val(),$(\'squareInput15\').val(),$(\'squareInput16\').val(),$(\'squareInput17\').val(),$(\'#squareInput1\').val(),$(\'#squareInput2\').val(),$(\'#squareInput3\').val(),$(\'#squareInput4\').val(),$(\'#squareInput5\').val(),$(\'#squareInput6\').val(),$(\'#squareInput7\').val(),$(\'#squareInput8\').val(),$(\'#squareInput9\').val(),$(\'#datepicker\').val())"><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/schedule.php?id='.$teacherid.'&eid=1&nweek=4"><img src="http://mathking.kr/Contents/Moodle/save.gif" width=30></a></button>';
 	$weektime=$memo9;
	}
...
<th scope="col" style="width: 10%;">✎ 개인 일정</th>
...
<th scope="col" style="width: 15%;"><input type="text" class="form-control" id="datepicker" name="datepicker"   value="today"  placeholder="임시 시간표인 경우 선택"></th>

<th scope="col" style="width:13%;">'.$savebutton.'</th><tr></table>
								</div>
							</div>
						</div>
					</div>
	...
	<script>
		function editschedule(Eventid,Userid,Start1,Start2,Start3,Start4,Start5,Start6,Start7,Duration1,Duration2,Duration3,Duration4,Duration5,Duration6,Duration7,Room1,Room2,Room3,Room4,Room5,Room6,Room7,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8,Memo9,Date,Start11,Start12,Start13,Start14,Start15,Start16,Start17){		 
			...
			"date":Date,			
					...
					$.ajax({
					url:"../students/checkfeedback.php",
					type: "POST",
					dataType:"json",
				 	data : {
					"eventid":\'2\',
		...
		function editschedule2(Eventid,Userid,Start1,Start2,Start3,Start4,Start5,Start6,Start7,Duration1,Duration2,Duration3,Duration4,Duration5,Duration6,Duration7,Room1,Room2,Room3,Room4,Room5,Room6,Room7,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,Memo7,Memo8,Memo9,Date){		 
