...
{	 
    ...
    { 
        ...
        echo '<script>
        var totalSeconds = '.$lefttime_seconds.'; // 남은 시간을 초 단위로 저장
        ...
        var auto_refresh = setInterval(function () {
            if (totalSeconds > 0) {
                totalSeconds = totalSeconds - 10; // 10초씩 감소
            } else {
                totalSeconds = 0;
            }
    ...
    echo '<table align=center width=90%>
         ...
         <table align=center width=70%>
            <tr><td>
                ...
                <td>DMN 휴식 <input type="checkbox" name="checkAccount" '.$status4.' onClick="Resttime(33,\''.$studentid.'\',\''.$goalid.'\', this.checked)"/> |  <a href="https://blog.naver.com/esuai02/223627321735" target="_blank">포모도르 공부법</a>  <audio controls style="margin-top:5px;width:150px;height:20px;" 
