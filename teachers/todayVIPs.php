...
include("navbar.php");
$timecreated=time();
$DB->execute("INSERT INTO {abessi_missionlog} (userid,page,timecreated) VALUES('$teacherid','teachertodayVIPs','$timecreated')");
...
unset($user); 
echo '<hr>오늘 집중관리 대상 상세 정보 (클릭해서 추가 또는 평소 평점보다 2단계 이상 떨어지면 자동 추가, 회복되면 자동 삭제), 중간점검 정보... 시각화, 오답노트/오답수 % 표시, 오답노트 필기양 측정 결과 이상인 경우 표시<hr>문제진단 메뉴로 선택 (오답노트, 집중력, 컨디션 관리, 커리큘럼 이탈, 오늘의 미션 집중도, 질문 타이밍 놓치는 경우, 정리 타이밍 부실.)<hr>';
echo '<table align="center" style="width: 100%;"><tr><td align=center><a href="https://mathking.kr/moodle/admin/user.php" target="_blank">사용자 검색</a></td></tr></table><hr>';
