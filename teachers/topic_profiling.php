...
$role=$userrole->role;  
$timeline=$DB->get_records_sql("SELECT * FROM mdl_abessi_timeline WHERE wboardid='$id'  AND timecreated> '$hoursago12'   ORDER BY id DESC");
...
foreach($result as $value)
    ...
    // visualization
    //$snapshots='tshot | '.$value['tstamparray'].' | gid '.$value['gidarray'];
    ...
    for ($i = 0; $i < count($generate_ids); $i++) 
        ...
        $barWidth = $timegap*5; // 폭을 $timegap 값에 비례하게 설정
        ...
        //$snapshots.='<span type="button" onClick="showMoment(\''.$wboardid.'\',\''.$generate_id.'\')" style="display:inline-block; width:'.$barWidth.'px; height:20px; background-color:'.$color.'; margin-right:5px;"></span>';
        }

    if($timestayed<0)$timestayed='...';
	...
	if(strpos($wboardid, 'jnrsorksqcrark')!== false)
		...
		$timelog.='<tr><td width=8%  style="background-color:white; font-size:15px; white-space:nowrap; color:'.$durationcolor.';overflow: hidden; text-overflow: ellipsis;"  align=center>   '.$timestamp.'   ('.round($timestayed/60,1).')</td><td>'.$value['status'].'</td><td style="font-size:'.$fontsize.';">'.$value['nview'].'</td><td width=5% align=center><div class="tooltip3">  <span><a style="color:#000000;text-decoration:none;font-size:'.$fontsize.'px;" href="https://mathking.kr/moodle/local/augmented_teacher/teachers/focused_analysis.php?wboardid='.$wboardid.'">'.iconv_substr($wboardid, 0, 20, "utf-8").'</a></span> <span class="tooltiptext3"><table><tr><td> <img loading="lazy"  src='.$imgSrc.' width=100%></td></tr></table></span></div></td><td align=center><a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_record.php?id='.$wboardid.'"target="_blank"> <img loading="lazy"  src="https://mathking.kr/Contents/IMAGES/createnote.png" width=10></a></td><td>'.$snapshots.'</td></tr>'; 
	} 
	...
	<table align=center width=90%><tr><th valign=top><div class="table-wrapper"><table width=100%><thead><tr><th style=" white-space:nowrap; color:black;overflow: hidden;" width=1%><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic_timeline.php?userid='.$studentid.'"><img style="margin-bottom:0px;" src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png width=30></a></th><th width=1%></th><th style="color:#1956FF;font-size:10px;white-space:nowrap; color:black;overflow: hidden;" width=3%><a style="text-decoration:none;color:#1956FF;font-size:10px;" href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$studentid.'&tb=604800">'.$stdname.'</a> </><th width=5%></th><th width=5%></th><th><table align=center><tr>'.$examplenote.'</tr></table></th></tr></thead><tr><td><hr></td><td><hr></td><td><hr></td><td><hr></td><td><hr></td><td><hr></td><td><hr></td></tr>'.$timelog.'</table></div></th></tr></table><br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> <br> ';
...
function showMoment(Wbid,Gidmax)
    {
    Swal.fire({
    backdrop: false,position:"bottom-right",showCloseButton: true,
    width: 1200,
    height:600,
    ...
    customClass: {
      ...
      html:
        \'<iframe style="border: 1px none; z-index:2; width:1150;height:550px;  margin-left: 0px;margin-right: 0px; margin-top: 0px; "  src="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_review.php?id=\'+Wbid+\'&gidmax=\'+Gidmax+\'" ></iframe>\',
