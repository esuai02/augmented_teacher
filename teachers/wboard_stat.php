...
foreach($result as $value)
    ...
    for ($i = 0; $i < count($generate_ids); $i++) 
        ...
        $snapshots.='<span type="button"  style="display:inline-block; width:'.$barWidth.'px; height:20px; background-color:'.$color.'; margin-right:5px;"></span>';
        }
