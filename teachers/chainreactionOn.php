...
foreach($result as $user)
	...
	//$goalreflection1=iconv_substr($goal->reflection1,0,15, "utf-8");
	$goalreflection2=iconv_substr($goal->reflection2,0,15, "utf-8");	
	
	//$goalreflection2 를 값에 따라서 문구로 전환해서 표시 컬러도 다르게 
	if($goalreflection2==1)$goalreflection2='<span style="color:red;">살짝 헤맸음</span>';
	elseif($goalreflection2==2)$goalreflection2='<span style="color:orange;">집중이 좀 흐트러짐</span>';
	elseif($goalreflection2==3)$goalreflection2='<span style="color:blue;">무난하게 좋았음</span>';
	elseif($goalreflection2==4)$goalreflection2='<span style="color:purple;">집중 잘 됨 !</span>';
	elseif($goalreflection2==5)$goalreflection2='<span style="color:green;">오늘 텐션 좋았음 !</span>';
	...
	$seenalt='('.round($indicators->nalt/3,1).'회/일)';
 	if($indicators->nalt/3<2)$ALTstatus='<a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/student_inbox.php?userid='.$userid.'" target="_blank"><span style="color:white;width:100px;">📬</span></a> <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/capturemathquestion.php?userid='.$userid.'" target="_blank"><span style="color:white;width:100px;">📸</span></a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic_timeline.php?userid='.$userid.'" target="_blank"><span style="color:white;width:100px;">🏁</span></a>';
	else $ALTstatus='<a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/student_inbox.php?userid='.$userid.'" target="_blank"><span style="color:white;width:100px;">📬</span></a>   <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/capturemathquestion.php?userid='.$userid.'" target="_blank"><span style="color:white;width:100px;">📸</span></a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic_timeline.php?userid='.$userid.'" target="_blank"><span style="background-color:green;color:white;width:100px;">✳️</span></a>';
	...
	*/
	...
	if($timespent>=5)$timespent='<a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><b style="color:#FE9900;font-size:25px;">👀</b></a>';
	...
	if($goal->status==='warning' && $goal->alerttime3 <= $goal->alerttime4  && $goal->type!=='검사요청' || $ptcomplete==='*')
		{
		if($triggered>30 && $ptcomplete==='*') $caretheseusers.='<a style="font-size:20px; color:red;" href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank">'.$studentname.'</a>   |';
		elseif($ptcomplete!=='*')  $caretheseusers.='<a style="font-size:16px;" href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank">'.$studentname.'</a>   |';
	...
	$userinfo='<td width=15%> <input type="checkbox" onClick="submittoday(21,\''.$userid.'\',this.checked)"/> <span onclick="addtowaitinglist(\''.$userid.'\',\''.$goal->id.'\')">'.$imgtoday.'</span><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$userid.'&tb=604800"target="_blank">'.$studentname.'</a> <a href="https://mathking.kr/moodle/message/index.php?id='.$userid.' " target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1627202411001.png" width=20></a>  </td>';
	...
	if($goal->type=='검사요청'  && $goalreflection2!=NULL) // 귀가검사 완료
		{
		$wgoaltext=iconv_substr($wgoal->text, 0,20, "utf-8");
		if($ratio>=90 && $ninactive==0)$nbreak='<b>프리패스</b><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a>';
		else $nbreak='<b>귀가검사</b><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a>';
		...
		$userlist01.='<tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><td width=15%><span onclick="addtowaitinglist(\''.$userid.'\',\''.$goal->id.'\')">'.$imgtoday.'</span><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$userid.'&tb=604800"target="_blank">'.$studentname.'</a> <a href="https://mathking.kr/moodle/message/index.php?id='.$userid.' " target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1627202411001.png" width=20></a> </td><td style="color:blue;font-size:16px;">'.$statustext.' </td><td> '.$goalpcomplete.'% ('.$schedule->weektotal.'h)</td><td width=12%><a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/cjnstudents/mypersonas.php?userid='.$userid.'"target="_blank">🎭</a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'"target="_blank">'.$instructiontext.'</a> &nbsp; '.$tracktime
		.'</td><td>   <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/wboarduserstat_display.php?userid='.$userid.'"target="_blank">▒</a> </td><td></td><td width=6%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$hours.'</a></td><td width=30%> 참여태도 : '.$goalreflection2.'  </td><td  width=30%><a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dashboard.php?userid='.$userid.'"target="_blank">🟩귀검 &nbsp; </a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$userid.'"target="_blank">🟦 '.$goaltext.' </a></td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';
		} 
	elseif($goal->type=='검사요청') // 귀가검사 요청
		...
		$tsubmitted=(INT)(($timecreated-$goal->timemodified)/60).'분';
		if($tsubmitted>60)$tsubmitted=round($tsubmitted/60,0).'시간'; 
		if($ninactive==0)$statustext='<span style="color:green;">'.$nbreak.'<a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a>'.$ninactivestr.'</span></td><td> &nbsp;&nbsp;<b> ('.$tsubmitted.')</b>';
		else $statustext='<span style="color:green;">'.$nbreak.'<a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a> '.$ninactivestr.'</span></td><td> &nbsp;&nbsp;<b> ('.$tsubmitted.')</b>';	
		$goalresult=$goal->result; 
		$goalpcomplete=$goal->pcomplete;
		if($goalresult/$goalpcomplete<0.8)$goalresult='<b style="color:red;">'.$goalresult.'</b>';

		if($goalreflection2==NULL)$userlist02 .= '<tr><td><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$userid.'&tb=604800"target="_blank">'.$studentname.'</a>의 오늘 수업 참여모습 어땠나요 ?</td><td></td><td></td><td width="12%"></td><td></td><td></td><td></td><td></td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'" target="_blank" style="display:inline-block;padding:6px 12px;background:#4CAF50;color:#fff;border-radius:6px;text-decoration:none;font-weight:bold;font-size:14px;box-shadow:0px 2px 4px rgba(0,0,0,0.2);transition:0.2s;" onmouseover="this.style.background=\'#45a049\'" onmouseout="this.style.background=\'#4CAF50\'">리뷰 남기기</a></td><td></td><td></td></tr>';
		else $userlist02.='<tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><td width=15%><span onclick="addtowaitinglist(\''.$userid.'\',\''.$goal->id.'\')">'.$imgtoday.'</span><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$userid.'&tb=604800"target="_blank">'.$studentname.'</a> <a href="https://mathking.kr/moodle/message/index.php?id='.$userid.' " target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1627202411001.png" width=20></a> </td><td style="color:blue;font-size:16px;">'.$statustext.' </td><td> '.$goalpcomplete.'% ('.$schedule->weektotal.'h)</td><td width=12%><a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/cjnstudents/mypersonas.php?userid='.$userid.'"target="_blank">🎭</a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'"target="_blank">'.$instructiontext.'</a> &nbsp; '.$tracktime.' <b style="display: inline-block; width: 30px;">('.$nlazy.')</b></td><td>   <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/wboarduserstat_display.php?userid='.$userid.'"target="_blank">▒</a> </td><td></td><td width=6%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$hours.'</a></td><td width=30%> 참여태도 : '.$goalreflection2.' </td><td width=30%>  <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dashboard.php?userid='.$userid.'"target="_blank">🟩귀검 &nbsp; </a>🟦 '.$goaltext.'  </td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';
		} 
	elseif($goal->inspect==2) // 오프라인  
		...
		$non_onlineusers.='<tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">'.$userinfo.'<td width=5%>'.$fixnote.' <a href="https://mathking.kr/moodle/local/augmented_teacher/students/dashboard_fixnotes.php?userid='.$userid.'"target="_blank"><b style="color:blue;">NOTE</b></a>&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/ktmcopilot.php?tab=tab4&userid='.$userid.'&mode=directions" target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/gatetosubconsciousness.png" width=20></a>&nbsp;&nbsp;</td><td width=10% style="color:blue;font-size:16px;"><b style="color:black;">'.$statustext.'</b> </td><td width=10%> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a></td><td width=10%>('.$timespent.' | '.$ninactivestr.'회)</td><td width=12%><a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/cjnstudents/mypersonas.php?userid='.$userid.'"target="_blank">🎭</a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'"target="_blank">'.$instructiontext.'</a> &nbsp; '.$tracktime.' <b style="display: inline-block; width: 30px;">('.$nlazy.') </b></td><td width=10%>  <a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_onair.php?userid='.$userid.'&mode=1"target="_blank"><img src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1624721323001.png" width=50px></a>('.$kpomodoro.')&nbsp;&nbsp;&nbsp;</td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/wboarduserstat_display.php?userid='.$userid.'"target="_blank">▒</a> &nbsp;&nbsp;&nbsp;</td><td width=10%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$lefttime.'</a></td><td width=22%><a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dashboard.php?userid='.$userid.'"target="_blank">🟩귀검 &nbsp; </a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$userid.'"target="_blank">🟦 '.$goaltext.'</a></td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';
		}
	...
	elseif($tlaststroke<30)
		{
		$userlist1.='<tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">'.$userinfo.'<td width=5%>'.$fixnote.' <a href="https://mathking.kr/moodle/local/augmented_teacher/students/dashboard_fixnotes.php?userid='.$userid.'"target="_blank"><b style="color:blue;">NOTE</b></a>&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/ktmcopilot.php?tab=tab4&userid='.$userid.'&mode=directions" target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/gatetosubconsciousness.png" width=20></a>&nbsp;&nbsp;</td><td width=10% style="color:blue;font-size:16px;">'.$tlaststroke.'초 </td><td width=10%> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a> </td><td width=10%>('.$timespent.' | '.$ninactivestr.'회)</td><td width=12%><a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/cjnstudents/mypersonas.php?userid='.$userid.'"target="_blank">🎭</a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'"target="_blank">'.$instructiontext.'</a> &nbsp; '.$tracktime.' <b style="display: inline-block; width: 30px;">('.$nlazy.') </b></td><td width=10%>  <a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_onair.php?userid='.$userid.'&mode=1"target="_blank"><img src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1624721323001.png" width=50px></a>('.$kpomodoro.')&nbsp;&nbsp;&nbsp;</td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/wboarduserstat_display.php?userid='.$userid.'"target="_blank">▒</a> &nbsp;&nbsp;&nbsp;'.$statustext.'</td><td width=10%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$lefttime.'</a></td><td width=22%><a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dashboard.php?userid='.$userid.'"target="_blank">🟩귀검 &nbsp; </a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$userid.'"target="_blank">🟦 '.$goaltext.'</a></td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';	
		}
	...
	elseif($tlaststroke<43200) 
		{
		$userlist5.='<tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">'.$userinfo.'<td width=5%>'.$fixnote.' <a href="https://mathking.kr/moodle/local/augmented_teacher/students/dashboard_fixnotes.php?userid='.$userid.'"target="_blank"><b style="color:blue;">NOTE</b></a>&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/ktmcopilot.php?tab=tab4&userid='.$userid.'&mode=directions" target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/gatetosubconsciousness.png" width=20></a>&nbsp;&nbsp;</td><td width=10% style="color:blue;font-size:16px;"><span style="color:red;" Onclick="quickReply2(333,\''.$userid.'\',\''.$goal->id.'\',2);" >이탈</span>('.round($tlaststroke/60,0).'분) </td><td width=10%> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a></td><td width=10%>('.$timespent.' | '.$ninactivestr.'회)</td><td width=12%><a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/cjnstudents/mypersonas.php?userid='.$userid.'"target="_blank">🎭</a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'"target="_blank">'.$instructiontext.'</a> &nbsp; '.$tracktime.' <b style="display: inline-block; width: 30px;">('.$nlazy.') </b></td><td width=10%>  <a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_onair.php?userid='.$userid.'&mode=1"target="_blank"><img src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1624721323001.png" width=50px></a>('.$kpomodoro.')&nbsp;&nbsp;&nbsp;</td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/wboarduserstat_display.php?userid='.$userid.'"target="_blank">▒</a> &nbsp;&nbsp;&nbsp;'.$statustext.'</td><td width=10%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$lefttime.'</a></td><td width=22%><a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dashboard.php?userid='.$userid.'"target="_blank">🟩귀검 &nbsp; </a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$userid.'"target="_blank">🟦 '.$goaltext.'</a></td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';
		...
		{
		$userlist6.='<tr style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">'.$userinfo.'<td width=5%>'.$fixnote.' <a href="https://mathking.kr/moodle/local/augmented_teacher/students/dashboard_fixnotes.php?userid='.$userid.'"target="_blank"><b style="color:blue;">NOTE</b></a>&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/ktmcopilot.php?tab=tab4&userid='.$userid.'&mode=directions" target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/gatetosubconsciousness.png" width=20></a>&nbsp;&nbsp;</td><td width=10% style="color:blue;font-size:16px;"><span style="color:lightgrey;" Onclick="quickReply2(333,\''.$userid.'\',\''.$goal->id.'\',2);" >대기</span> </td><td width=10%> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$teacherid.'&userid='.$userid.'"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png" width=25></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$userid.'&type=init"target="_blank"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/timefolding.png" width=25></a></td><td width=10%>('.$timespent.' | '.$ninactivestr.'회)</td><td width=12%><a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/cjnstudents/mypersonas.php?userid='.$userid.'"target="_blank">🎭</a>  <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding.php?userid='.$userid.'"target="_blank">'.$instructiontext.'</a> &nbsp; '.$tracktime.' <b style="display: inline-block; width: 30px;">('.$nlazy.') </b></td><td width=10%>  <a style="font-size:20px;" href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_onair.php?userid='.$userid.'&mode=1"target="_blank"><img src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1624721323001.png" width=50px></a>('.$kpomodoro.')&nbsp;&nbsp;&nbsp;</td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/wboarduserstat_display.php?userid='.$userid.'"target="_blank">▒</a> &nbsp;&nbsp;&nbsp;'.$statustext.'</td><td width=10%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$lefttime.'</a></td><td width=22%><a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dashboard.php?userid='.$userid.'"target="_blank">🟩귀검 &nbsp; </a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$userid.'"target="_blank">🟦 '.$goaltext.'</a></td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';
		if($goal->checktime<$minutes5 && $goal->inspect==0)$DB->execute("UPDATE {abessi_today} SET status='warning',ninactive=ninactive+1, checktime='$timecreated' WHERE userid='$userid'  AND type LIKE '오늘목표'  ORDER BY id DESC LIMIT 1");	 
		else $DB->execute("UPDATE {abessi_today} SET activetime=activetime+300 WHERE userid='$userid'  AND type LIKE '오늘목표'  ORDER BY id DESC LIMIT 1");	
		if($goal->activetime>3600)$DB->execute("UPDATE {abessi_today} SET  activetime=0,ninactive=ninactive-1 WHERE userid='$userid'  AND type LIKE '오늘목표'  ORDER BY id DESC LIMIT 1");	 
		}	
...
echo '
		<div class="main-panel">  
			<div class="content">     
				...
				<audio id="bgMusic1" style="display:none;">
					<source src="https://mathking.kr/Contents/audiofiles/music/audio_2289_2_1761126492.mp3" type="audio/mpeg">
				</audio> 
				<audio id="bgMusic2" style="display:none;">
					<source src="https://mathking.kr/Contents/audiofiles/music/audio_2283_2_1761125832.mp3" type="audio/mpeg">
				</audio>
				<table align=center width=90%><tr>  <td><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/papertest.php?id='.$teacherid.'"target="_blank">✍🏻</a> &nbsp;&nbsp;&nbsp;	</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://chatgpt.com/g/g-elB1Niwrc-hagseub-pereusona-saengseonggi" accesskey="r"><b>학습 페르소나</b></a></td><td>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/omniui/student_management.php?userid='.$teacherid.'&search=&sort=name&dir=asc"target="_blank">🧑수업관리</a>&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/Goclassroomgame.php?userid='.$teacherid.'"target="_blank">🧊</a> |  <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/classdashboard.php?userid='.$teacherid.'"target="_blank">🧑귀가검사</a> | 🤖<a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/teachingagent.php?userid='.$teacherid.'">AI 질의응답</a> </td><td><a href="javascript:void(0);" onclick="toggleMusic(\'bgMusic1\', this)">🎵AlphaTutor, 빛이 되어</a> <a href="https://mathking.kr/Contents/audiofiles/music/audio_2289_2_1761126492.mp3" target="_blank" style="font-size:0.8em;">🔗</a></td> <td><a href="javascript:void(0);" onclick="toggleMusic(\'bgMusic2\', this)">🎵AlphaTutor, 위대한 스승들의 나라</a> <a href="https://mathking.kr/Contents/audiofiles/music/audio_2283_2_1761125832.mp3" target="_blank" style="font-size:0.8em;">🔗</a></td> <td><audio controls style="width:200px;height:20px;"
							...
							<div class="invoice-detail"> 
								<div class="invoice-item"><br>	
									<div class="table-responsive">
										<table width=100%><tr><td><table width=90%><tr><td>#도움요청</td><td>&nbsp;</td>'.$helpstamp.'</tr></table> </td><td><table width=90%><tr><td>#직접질문</td><td>&nbsp;</td>'.$questionstamp1.'</tr></table></td><td><table width=90%><tr><td>#개념질문</td><td>&nbsp;</td>'.$questionstamp2.'</tr></table></td><td><table width=90%><tr><td></td><td>&nbsp;</td><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/waitinglist.php?teacherid='.$teacherid.'"target="_blank">💫 대기명단</a>  &nbsp; &nbsp; &nbsp; 💫 <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/dailyreport.php?userid=<?php echo $teacherid; ?>" target="_blank">지난 수업 리포트</a>   &nbsp; &nbsp; &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/capturemathquestion.php?userid='.$teacherid.'" target="_blank">📸 질의응답 </a>   <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/realtime_dashboard.php?userid='.$teacherid.'" target="_blank">💫 실시간</a></tr></table></td></tr></table><hr><table align=center width=90%><tr><td>'.$replyfirst.'</td></tr></table>  
											<hr style="border: dashed 1px red;"><table width=90%><tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/dashboard_whiteboard.php?teacherid='.$teacherid.'"target="_blank">💫 선 넘은 아이들</a></b> &nbsp; &nbsp;&nbsp; '.$caretheseusers.'</td><td> &nbsp; &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/dashboard_fixnotes.php?teacherid='.$teacherid.'"target="_blank">💫 오답노트 검사</a>  &nbsp; &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/PomodoroStat.php?teacherid='.$teacherid.'"target="_blank">💫 포모도르 통계</a> </td></tr></table><hr>
...
.tooltip3:hover .tooltiptext3 {
  visibility: visible;
	...
	<script>
	// PHP에서 전달된 학생별 goalid 맵
 	
	function addtowaitinglist(Userid,goalid){ 
	swal("", "질문 대기목록에 추가되었습니다.", {buttons: false, timer: 2000});
		$.ajax({ 
			...
			success:function(data){
				swal("", "질문이 대기 목록에 추가되었습니다.", {buttons: false, timer: 2000});
				// 페이지 새로고침 (선택사항)
				setTimeout(function() {
					location.reload();
				}, 2000);
...
function submittoday(Eventid, Userid, Checkvalue){
    ...
    swal({
        title:"귀가 검사 안내",
        text:"학생에게 귀가 검사를 요청하시겠어요?",
        icon:"info",
        buttons:{
            request:{text:"요청하기", value:"request", className:"btn btn-primary"},
            continue:{text:"그냥 진행하기", value:"continue", className:"btn btn-success"},
            cancel:{text:"취소", value:"cancel", className:"btn btn-light"}
        }
    }).then(function(v){

        if(v === "request"){
            // 요청하기 → AJAX 없음, 메시지만
            swal("학생루틴 만들기","학생에게 직접 요청 바랍니다.","success");

        } else if(v === "continue"){

            // 그냥 진행하기 → 기존 AJAX 로직 그대로
...
function toggleMusic(audioId, linkElement) {
  console.log("[chainreactionOn.php:toggleMusic] audioId:", audioId);

  var audio = document.getElementById(audioId);
  if (!audio) {
    console.error("[chainreactionOn.php:toggleMusic] Audio element not found:", audioId);
    return;
  }

  // 다른 음악이 재생 중이면 멈춤
  if (currentPlayingMusic && currentPlayingMusic !== audio) {
    currentPlayingMusic.pause();
    currentPlayingMusic.currentTime = 0;

    // 다른 링크의 아이콘을 🎵로 변경
    var allLinks = document.querySelectorAll("a[onclick*=\'toggleMusic\']");
  ...
  if (audio.paused) {
    ...
    console.log("[chainreactionOn.php:toggleMusic] Playing:", audioId);
  } else {
    audio.pause();
    linkElement.textContent = linkElement.textContent.replace("⏸", "🎵");
    currentPlayingMusic = null;
    console.log("[chainreactionOn.php:toggleMusic] Paused:", audioId);
  }
  ...
  audio.onended = function() {
    linkElement.textContent = linkElement.textContent.replace("⏸", "🎵");
    currentPlayingMusic = null;
    console.log("[chainreactionOn.php:toggleMusic] Ended:", audioId);
  };
}
</script>';
