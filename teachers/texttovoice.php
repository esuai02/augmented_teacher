...
$audiofilename='audio_'.$USER->id.'_'.time().'.mp3';
$resp = $textToSpeechClient->synthesizeSpeech($input, $voice, $audioConfig);
file_put_contents('./uploads/'.$audiofilename, $resp->getAudioContent());
echo '<audio autoplay>
<source src="https://mathking.kr/moodle/local/augmented_teacher/teachers/uploads/'.$audiofilename.'" type="audio/mpeg">
</audio>';
