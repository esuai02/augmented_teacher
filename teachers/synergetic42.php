...
echo ' 	<table align=center width=100%><tr><th valign=top><div class="table-wrapper"><table width=100%><thead><tr><th style="white-space: nowrap;" width=10%><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter42.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$studentid.'&type=init"> <img loading="lazy"  src=https://mathking.kr/Contents/IMAGES/timefolding.png width=50></a> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/fixnote.php?userid='.$studentid.'"> <img loading="lazy"  src="https://www.mathking.kr/moodle/local/augmented_teacher/IMAGES/fixnote.png" width=40></a> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/activelearningnote.php?userid='.$studentid.'"> <img loading="lazy"  src="https://www.mathking.kr/moodle/local/augmented_teacher/IMAGES/commitnote.png" width=40></a>
