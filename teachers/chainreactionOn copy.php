...
foreach($result as $user)
	...
	*/
	...
	$userinfo='<td width=15%> <input type="checkbox" onClick="submittoday(21,\''.$userid.'\',this.checked)"/> <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/analysis/user_analysis.php?userid='.$userid.'"target="_blank">'.$imgtoday.'</a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$userid.'&tb=604800"target="_blank">'.$studentname.'</a> <a href="https://mathking.kr/moodle/message/index.php?id='.$userid.' " target="_blank" ><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1627202411001.png" width=20></a>  </td>';
	...
	if($goal->type=='검사요청' && $timecreated-$goal->timemodified>1800) // 귀가검사 완료
		...
		.'</td><td>   <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$userid.'&mode=today"target="_blank"><img loading="lazy" src=https://mathking.kr/Contents/IMAGES/replay.png width=15></a> </td><td></td><td width=6%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$userid.'&eid=1&nweek=12"target="_blank">'.$hours.'</a></td><td width=30%> 참여태도 : '.$goalreflection2.'  </td><td  width=30%><a href="https://mathking.kr/moodle/local/augmented_teacher/students/weeklyplans.php?id='.$userid.'&cid='.$chapterlog->cid.'&pid='.$termplan->id.'"target="_blank">🟦</a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/dailygoals.php?id='.$userid.'&cid='.$chapterlog->cid.'&pid='.$wgoal->id.'"target="_blank">🟪</a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/todayplans.php?id='.$userid.'&cid='.$chapterlog->cid.'&pid='.$goal->id.'&nch='.$chapterlog->nch.'"target="_blank">🟩</a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$userid.'"target="_blank"><b>오늘</b> '.$goaltext.'</a></td><td align=right>'.$ALTstatus.'</td><td>'.$seenalt.'</td></tr>';
		}
