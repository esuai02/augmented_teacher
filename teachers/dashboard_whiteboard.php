<?php 
/* 최근 활동 분석 >> gpt >> 체크 사항 피드백 후 표시. gpt의 경우 chainreaction에서 업데이트.? 지연문제 해결.
왜 활동이 지연되었나 ? 직접관찰 후 입력.. 데이터 수집.. 관찰결과를 데이터로 식별하기 위한 알고리즘 개발하여
아래 해당 위치에 적용 1. 상세분석 페이지 정보에서 시작*/
...
foreach($result as $value)
    ...
    elseif($tlaststroke>60 && $tlaststroke<1800)
        {  
		/* 이곳에 분석 알고리즘 및 피드백 알고리즘 적용 */




        $wboardlist.='<table width=40%><tr style="background-color:#c2ecff;"><td align=center><b style="font-size:40;">'.$stdname.(int)(($tlaststroke)/60).'분 전</b></td></tr><tr><td align=center><iframe scrolling="no" style="top: 0; left: 0; width: 100%; height:500px; border: 1px solid black;" src="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_light.php?userid='.$userid.'&time"></iframe></td></tr></table>';
        }
	} 
