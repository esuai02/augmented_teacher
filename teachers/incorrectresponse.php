...
include("navbar.php");
$timecreated=time();
$DB->execute("INSERT INTO {abessi_missionlog} (userid,page,timecreated) VALUES('$teacherid','teacherincorrectresponse','$timecreated')");
...
foreach($userlist as $user)
	...
	$t_ave=$tperiod/($ntry+0.000000001);
	...
	if($Qnum1/($Qnum2+0.0000001)<0.7)$imgtoday='https://mathking.kr/Contents/Moodle/Visual%20arts/todayD.png';
	elseif($Qnum1/($Qnum2+0.0000001)<0.75)$imgtoday='https://mathking.kr/Contents/Moodle/Visual%20arts/todayC.png';
	elseif($Qnum1/($Qnum2+0.0000001)<0.8)$imgtoday='https://mathking.kr/Contents/Moodle/Visual%20arts/todayCplus.png';
	elseif($Qnum1/($Qnum2+0.0000001)<0.85)$imgtoday='https://mathking.kr/Contents/Moodle/Visual%20arts/todayB.png';
	elseif($Qnum1/($Qnum2+0.0000001)<0.9)$imgtoday='https://mathking.kr/Contents/Moodle/Visual%20arts/todayBplus.png';
	elseif($Qnum1/($Qnum2+0.0000001)<0.95)$imgtoday='https://mathking.kr/Contents/Moodle/Visual%20arts/todayA.png';
	...
	foreach($result1 as $value)
		...
		$mid='mymodal'.$qidtmp;
		$btntitle='보기';
		$feedback='<td><button type="text" style="background-color:green;color:white;width:50px;" data-toggle="modal" data-target="#'.$reply.'">검색</button></td>';
		...
		<!-- 질의응답을 위한 의사소통을 위한 modal -->
  		<div class="modal fade"  id="'.$mid.'" role="dialog"><div class="modal-dialog modal-xl"><div class="modal-content"><div class="modal-header">
		...
		<p><a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$value['questionid'].'" target="_blank">
		'.$value['questiontext'].'</a></p><p align="right"><button type="button" onclick="askstudent(11,'.$userid.','.$teacherid.','.$qidtmp.')">질문의사 확인하기</button></p>
		...
		$$today.='<tr><td>&nbsp;&nbsp;</td><td><img src="'.$imgtoday.'" width=25></td><td><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$userid.'&tb=43200 " target="_blank" >'.$firstname.$lastname.'</a></td><td>('.round($lastaction/60,0).'분)</td>
