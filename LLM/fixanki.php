...
<table align=right><tr><td>&nbsp;&nbsp;&nbsp; <a href="https://chat.openai.com/g/g-RNnwgPr07-jimyeonpyeongga-culje-dogu"target="_blank"><button>지시사항 +</button></a> '.$instructionBtn1.' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://chatgpt.com/g/g-NHQ5KMkvu-anki-kwijeu-saengseonggi"target="_blank"><button>ANKI 퀴즈</button></a>'.$instructionBtn2.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://chat.openai.com/g/g-fFLnnjprZ-jeonmun-nareisyeon-saengseongjangci"target="_blank"><button>나레이션 +</button></a><a href="https://elevenlabs.io/?utm_source=elevenlabs_gpt"target="_blank"><button>오디오생성</button></a><button id="audio_upload" type="button" class="" data-toggle="collapse" data-target="#demo" accesskey="a">업로드</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button onclick="saveContent(\''.$eventid.'\',$(\'#squareInput\').val(),\''.$ankiquizid.'\')">저장하기</button></td><td width=10%></td></tr></table><br><br><br><br><br><br><br><br></td></tr></table>';
...
echo '<script>   
function saveContent(Eventid,Inputtitle,Quizid)
  {
