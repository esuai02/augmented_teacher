...
<div><table align=center><tr><td valign=top style="font-size:12px;"  class="no-print">  <button id="createwhiteboard" onclick="convertToImageAndUpload(\''.$studentid.'\',\''.$cntid.'\',\''.$print.'\')">업데이트</button> &nbsp;&nbsp;&nbsp;&nbsp;'.$Hippocampustest.'</td></tr></table></div><br><br><br><br><br><br><br></body></html> 
