...
if (empty($openai_api_key)) {
    error_log('[copilots_metacognition.php:' . __LINE__ . '] OPENAI_API_KEY 환경변수가 설정되지 않았습니다.');
}
...
$headdesign='<table width=80% align=center><tr><td>'.$currentAnswer.'</td><td width=5%></td><td><span id="nexttalk" align=center>NEXT</span></td><td width=2%></td><td  width=5%><span id="startTalk" align=center style="white-space:nowrap;">초기화</span></td></tr></table><table align=center><tr><td><img src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/insideout.png width=200></td></tr></table><br><hr>';
