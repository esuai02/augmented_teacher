...
elseif($cnttype==2)
    ...
    <table align=right><tr><td>&nbsp;&nbsp;&nbsp;   &nbsp;&nbsp;&nbsp; <a href="https://chatgpt.com/g/g-6902128bfdf08191a2e9d043f73a2045"target="_blank"><button>오개념활용 GPT</button></a>&nbsp;&nbsp;&nbsp;<a href="https://chatgpt.com/g/g-690210ae1d1c819191b6df2f183c2fa2"target="_blank"><button>일시정지대화 GPT</button></a>&nbsp;&nbsp;&nbsp;<a href="https://chat.openai.com/g/g-RNnwgPr07-jimyeonpyeongga-culje-dogu"target="_blank"><button>단계지시 GPT</button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://chat.openai.com/g/g-fFLnnjprZ-jeonmun-nareisyeon-saengseongjangci"target="_blank"><button>나레이션 +</button></a> <a href="https://mathking.kr/moodle/local/augmented_teacher/books/openai_tts.php?cid='.$cntid.'&ctype='.$cnttype.'"target="_blank"><button>오디오생성</button></a><button id="audio_upload" type="button" class="" data-toggle="collapse" data-target="#demo" accesskey="a">업로드</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <button onclick="saveContent(\''.$eventid.'\',\''.$cntid.'\')">저장하기</button></td><td width=10%></td></tr></table><hr>
    '.$editcontent.'';
   ...
   $cntimgs= '<td>'.$cnttext2.'</td><td>'.$cnttext1.'</td>';
      ...
      $textareas='<br><br><table width=100% height=70%><tr><td align=left style="color:green;font-size:18px;" valign=top>다음 내용을 클릭,복사하여 GPT에 입력</td></tr><tr><td valign=top  class="copyable" valign="top" style="cursor: pointer;background-color:#D5F3FE;">'.$maintext.'</td>'.$cntimgs.'</tr></table><br><br><table width=100% height=30% style="table-layout:fixed;"><tr><td width=50% align=left style="color:green;font-size:18px;">지시사항</td><td width=50% align=left style="color:green;font-size:18px;"><table><tr><td><select  id="basic" name="quizOptions"><option value="quiz1">빈칸 채우기</option><option value="quiz2">유사문제</option><option value="quiz3">변형문제</option><option value="quiz4">계산연습</option><option value="quiz5">개념 서술평가</option><option value="quiz6">난이도 연습문제</option><option value="quiz7">복잡도 연습문제</option><option value="quiz8">분석지점 연습문제</option></select> | <a href="https://mathking.kr/moodle/local/augmented_teacher/LLM/editcontents.php?cntid='.$cntid.'&cnttype='.$cnttype.'"target="_blank">보충학습</a> :</td><td>'.$allcontents.'</tr></table></td></tr><tr><td width=50% valign=top><textarea id="mytextarea0">'.$guidetext1.'</textarea> </td><td width=50% valign=top><textarea id="mytextarea1">'.$guidetext2.'</textarea> </td></tr></table>
      <table align=right><tr><td>&nbsp;&nbsp;&nbsp;<a href="https://chatgpt.com/g/g-690210ae1d1c819191b6df2f183c2fa2"target="_blank"><button>일시정지대화 GPT</button></a>&nbsp;&nbsp;&nbsp;<a href="https://chat.openai.com/g/g-RNnwgPr07-jimyeonpyeongga-culje-dogu"target="_blank"><button>단계지시 GPT</button></a>&nbsp;&nbsp;&nbsp;<a href="https://chatgpt.com/g/g-68ed08ad8898819185fb057fb5583786-injijeog-dojehagseub-jeonmunga"target="_blank"><button>절차기억 GPT</button></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/openai_tts_pmemory.php?cid='.$cntid.'&ctype='.$cnttype.'"target="_blank"><button style="background-color:skyblue;">단계별 TTS 생성</button></a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="https://chatgpt.com/g/g-6902128bfdf08191a2e9d043f73a2045"target="_blank"><button>오개념활용 GPT</button></a><a href="https://chat.openai.com/g/g-fFLnnjprZ-jeonmun-nareisyeon-saengseongjangci"target="_blank"><button>내용설명 GPT</button></a><a href="https://mathking.kr/moodle/local/augmented_teacher/books/openai_tts.php?cid='.$cntid.'&ctype='.$cnttype.'"target="_blank"><button style="background-color:skyblue;">대화식 TTS 생성</button></a> <button id="image_upload" type="button" class="" data-toggle="collapse" data-target="#demo" accesskey="a">이미지 +</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button onclick="saveContent(\''.$eventid.'\',\''.$cntid.'\')">저장하기</button></td><td width=10%></td></tr></table><hr>'.$editcontent;
