...
if (empty($openai_api_key)) {
    error_log('[chatmentor.php:' . __LINE__ . '] OPENAI_API_KEY 환경변수가 설정되지 않았습니다.');
}
...
//$talka1,$talkb1를 contentstype, contentsid, stepid를 토대로 체크하여 있으면 DB에 저장된 내용을 $currentAnswer로 입력. DB 내용을 수동으로 수정하도록 만들기.
...
else $headdesign='<table width=60%  align=center><tr><td><h3 id="startTalk" align=center>시작<h3></td></tr></table><hr>
