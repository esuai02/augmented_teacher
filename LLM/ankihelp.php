...
<script src="../assets/js/plugin/sweetalert/sweetalert.min.js"></script>'; //<script> alert("과거 학습데이터를 토대로 최적의 보충학습을 찾고 있습니다");    </script>
...
<table  id="content-to-capture"  width=80% ><tr><td valign=top  class="no-print" width=2%><br><br>&nbsp;&nbsp;&nbsp;</td><td valign=top>'.$maintext.'</td><td valign=top><br><br><a href="https://chat.openai.com/g/g-apWVmPMop-hogisim-haegyeolsa"target="_blank"><img class="no-print" src="https://mathking.kr/Contents/IMAGES/curiosity.png" width=30px></a></td></tr></table>
</div>
<div><table align=center><tr><td valign=top style="font-size:12px;"  class="no-print">  <button id="createwhiteboard" onclick="convertToImageAndUpload(\''.$studentid.'\',\''.$cntid.'\',\''.$print.'\')">화이트보드</button> &nbsp;&nbsp;&nbsp;&nbsp;'.$Hippocampustest.'</td></tr></table></div><br><br><br><br><br><br><br></body></html> 
