...
if (empty($openai_api_key)) {
    error_log('[chattutor_old.php:' . __LINE__ . '] OPENAI_API_KEY 환경변수가 설정되지 않았습니다.');
}
...
if($pagetype=='replay' || $pagetype=='whiteboard')$headdesign='<table width=80%><tr><td><h3 id="startTalk" align=center>대화시작<h3></td><td><span id="nexttalk" align=center>NEXT</span></td></tr></table><hr>';
else $headdesign='<table width=60%><tr><td><h3 id="startTalk" align=center>대화시작<h3></td></tr></table><hr>
