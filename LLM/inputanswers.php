...
<textarea id="mytextarea">'.$cnttext->description.'</textarea><table width=100%><tr><td>&nbsp;&nbsp;&nbsp;<button onclick="saveContent(\''.$eventid.'\',\''.$cntid.'\')">저장하기</button> </td><td align=right><a href="https://chat.openai.com/chat"target="_blank"><img src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/gpt.png width=20></a>&nbsp;&nbsp;&nbsp;</td></tr></table></td></tr></table>
  <script>
    tinymce.init({
      selector: "textarea",
