...
// 정규 표현식을 사용하여 유튜브 링크를 추출
preg_match_all('/(https:\/\/www\.youtube\.com\/watch\?v=[\w-]+|https:\/\/youtu\.be\/[\w-]+)/', $cntstr, $matches);
...
foreach ($youtubeLinks as $link) {
    // 유튜브 링크에서 비디오 ID 추출
    preg_match('/(?:https:\/\/www\.youtube\.com\/watch\?v=|https:\/\/youtu\.be\/)([\w-]+)/', $link, $idMatch);
    $videoId = $idMatch[1];
