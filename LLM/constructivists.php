...
if($thiscnt->id!=NULL)
   ...
   // if($mode==='modify')
      ...
      $preparegpt=$cnttext.'내용을 세밀하게 검토해줘. 중요한 내용들을 제대로 이해했는지 평가하기 위한 확인질문들 생성해줘. ';
      $firstdescription ='';
      }/*
    else 
      {
...
<div id="typing-container"><div><table align=left valign=top><tr><td valign=top><a href="'.$changeurl.'"><img src="'.$avartarimg.'"  width=100></a> </td><td valign=bottom><a href="https://mathking.kr/moodle/local/augmented_teacher/LLM/print_papertest.php?userid='.$studentid.'&wboardid='.$wboardid.'&cntid='.$thiscnt->id.'&cnttype=8&gid='.$gid.'"target="_blank">인쇄하기</a></td></tr></table>
...
<body>'.$part1.$part2.'</td></tr></table>'.$typenew.'<table width=90% align=center><tr><td> 
<div id="output-text"></div> </td></tr></table>
<div><table align=center><tr><td align="center"><input height=50px type="text" class="form-control input-square" id="input-text" name="squareInput"  placeholder="선택부분 상세 설명보기 클릭" value="'.$preparegpt.'" ></td><td></td><td width=3%><button class="submit-button3" id="startTalk" onclick=""><img src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/sendicon.png width=30></button></td><td><button style = "z-index:2;background-color:#C4C4C4;" onclick="saveResult();">저장</button></td></tr></table></div></body></html>
