...
if($pagetype==='replay' || $pagetype==='whiteboard' || $pagetype==='dialogue' )$headdesign='<table width=80% align=center><tr><td>'.$currentAnswer.'</td><td width=5%></td><td><span id="nexttalk" align=center><img src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/next.png width=25></span></td><td width=2%></td><td  width=5%><span id="startTalk" align=center style="white-space:nowrap;"><span id="nexttalk" align=center><img src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/restart.png width=25></span></td></tr></table><hr>';
elseif($pagetype==='mctalk'|| $pagetype==='topic') $headdesign='<table width=60%  align=center><tr><td><h3 id="startTalk" align=center><h3></td></tr></table><hr>';
else $headdesign='<table width=60%  align=center><tr><td><h3 id="startTalk" align=center><h3></td></tr></table><hr>';
