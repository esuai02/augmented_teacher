	  ...
	  <div class="col-md-12">
		...
		<td style="vertical-align: top;" width=25%>  
		  ...
		  <div class="demo" style="margin-top:3px;"> 
			&nbsp; DMN휴식</b> <input type="checkbox" name="checkAccount" id="dmnRestCheckbox"  '.$status4.' onClick="Resttime(33,\''.$studentid.'\',\''.$goalid.'\', this.checked)"/> &nbsp; <b>오프라인</b> <input type="checkbox" name="checkAccount"  '.$status5.' onClick="ChangeCheckBox(333,\''.$studentid.'\',\''.$goalid.'\', this.checked)"/>   &nbsp; '.$goalcomplete.'  <b> &nbsp;&nbsp;&nbsp; <span style="color:blue;">'.$tleft.'</span></b>  
		   </div>
			</td>
		  </tr></table>
		...
		function Resttime(Eventid,Userid, Goalid,Checkvalue)
		    ...
		    if(Checkvalue==true)
				...
				if(Timeleft<0)
					{
					Swal.fire({
					backdrop: true,position:"top-center",width:1000,
					  customClass: {
					...
					didClose: function() {
						...
						if(iframe && iframe.contentWindow) {
							...
							try {
								...
								console.log(\'Error in today.php:1237 - iframe message failed: \' + e.message);
							}
						}
					}
					}).then((result) => {
						...
						if(iframe && iframe.contentWindow) {
							try {
								...
								console.log(\'Error in today.php:1245 - iframe message failed: \' + e.message);
							}
						}
					});
