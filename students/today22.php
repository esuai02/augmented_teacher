<?php 
include_once("/home/moodle/public_html/moodle/config_abessi.php"); 
...
if($checkgoal->drilling==1)$alertimg='(<img loading="lazy" style="margin-bottom:5px;" src=https://mathking.kr/Contents/IMAGES/exist.gif width=30>)';
else $alertimg='';
$goalid=$checkgoal->id; 
...
//$result_review='<a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$summaryid.'&mode=today"target="_blank"><b style="color:white;">습관분석 <img loading="lazy" src=https://mathkin.kgr/moodle/local/augmented_teacher/students/improve.png width=50></b></a>';
...
// 활동 설계부
$todayplan='<table width=100%><tr><td><b>▶ 질의응답</b></td><td><button   type="button"  style = "font-size:16;background-color:'.$bgcolor.';color:white;border:0;outline:0;" onClick="quickReply(313,\''.$studentid.'\',\''.$goalid.'\')" >'.$btnname.'</button></td><td><button   type="button"  style = "font-size:16;background-color:'.$bgcolor2.';color:white;border:0;outline:0;" onClick="quickReply2(314,\''.$studentid.'\',\''.$goalid.'\')" >'.$btnname2.'</button></td></tr>'.$qlist.'</table><br>';
//ㄹㅇㅁㄹ
...
if($tamounttotal<=-5 && $attendlog->id !=NULL )$attendancetext='&nbsp; <b>'.$tamounttotal.'시간 </b>&nbsp;&nbsp;<a style="color:red; font-size:20pt" href="https://mathking.kr/moodle/local/augmented_teacher/students/schedule.php?id='.$studentid.'&eid=1&nweek=4">보강시간을 정해주세요 !</a> <img loading="lazy" src="https://mathking.kr/Contents/IMAGES/exist.gif" width=60>';
...
if($checkgoal->type==='검사요청') echo '<td style="width: 25%;height:20px;"><div><input type="text" class="form-control input-square" id="squareInput" name="squareInput"  placeholder="'.$placeholder.'" ></div></td>  <td style="width:5%;font-size: 20px; "><button id="clicksubmit" type="image" onclick="submittoday(21,'.$studentid.','.$pcomplete.',$(\'#basic1\').val(),$(\'#basic3\').val(),$(\'#basic5\').val(),$(\'#squareInput\').val())">제출</button></td><td style="font-size: 20px;width: 10%; text-align:center;"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$summaryid.'&mode=today"><img loading="lazy" src=https://mathking.kr/Contents/IMAGES/improve.png width=80></a></td> <td style="text-align:center;font-size: 20px; width: 10%;"><div style="text-align:center;font-size: 20px; " class="tooltip2">보강차감 (총 : '.$reducetime.' 분) 가능 <span class="tooltiptext2"><table style="" align=center>'.$eventtext.'</table></span></div>
<button type="image" onclick="updatetime(93,'.$studentid.','.$reducetime.','.$tamounttotal.')">적용</button></td></tr></table></div></div>  <br>';
else echo '<td style="height:20px;"><div><input type="text" class="form-control input-square" id="squareInput" name="squareInput"  placeholder="'.$placeholder.'" ></div></td> <td width=2%></td> <td style="width:10%;font-size: 20px; "><button id="clicksubmit" type="image" onclick="submittoday(21,'.$studentid.','.$pcomplete.',$(\'#basic1\').val(),$(\'#basic3\').val(),$(\'#basic5\').val(),$(\'#squareInput\').val()) ">제출</button></td> <td style="font-size: 20px;width: 10%; text-align:center;"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$summaryid.'&mode=today"><img loading="lazy" src=https://mathking.kr/Contents/IMAGES/improve.png width=80></a></td><td style="text-align:center;font-size: 20px; width: 10%;"><div style="text-align:center;font-size: 20px; " class="tooltip2">보강차감 (총 : '.$reducetime.' 분) 가능<span class="tooltiptext2"><table style="" align=center>'.$eventtext.'</table></span></div></td> </tr></table></div></div>  <br>';

// 퀴즈 및 화이트보드 출력부
$recoveryrate=$nrecovery/($ncomplete+$nreview)*100; 
$progresstext='총 '.round($predict->totaltime/3600,1).'시간 ';
if($predict->prob1!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time1.'">'.$predict->prob1.'%/'.round(($predict->time1-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text1.'</td></tr></table></span></div>';
if($predict->prob2!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time2.'">'.$predict->prob2.'%/'.round(($predict->time2-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text2.'</td></tr></table></span></div>';
if($predict->prob3!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time3.'">'.$predict->prob3.'%/'.round(($predict->time3-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text3.'</td></tr></table></span></div>';
if($predict->prob4!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time4.'">'.$predict->prob4.'%/'.round(($predict->time4-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text4.'</td></tr></table></span></div>';
if($predict->prob5!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time5.'">'.$predict->prob5.'%/'.round(($predict->time5-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text5.'</td></tr></table></span></div>';
if($predict->prob6!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time6.'">'.$predict->prob6.'%/'.round(($predict->time6-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text6.'</td></tr></table></span></div>';
if($predict->prob7!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time7.'">'.$predict->prob7.'%/'.round(($predict->time7-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text7.'</td></tr></table></span></div>';
if($predict->prob8!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time8.'">'.$predict->prob8.'%/'.round(($predict->time8-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text8.'</td></tr></table></span></div>';
if($predict->prob9!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time9.'">'.$predict->prob9.'%/'.round(($predict->time9-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text9.'</td></tr></table></span></div>';
if($predict->prob10!=NULL)$progresstext.='<img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.png width=30><div class="tooltip3"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'&tbegin='.$predict->tbegin.'&tend='.$predict->time10.'">'.$predict->prob10.'%/'.round(($predict->time10-$predict->tbegin)/3600,1).'H </a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$predict->text10.'</td></tr></table></span></div>';
...
echo '<table align=center><tr><td><img loading="lazy" src=https://mathking.kr/Contents/IMAGES/agamotto.gif width=50>&nbsp;&nbsp;&nbsp;</td><td>'.$progresstext.' (<a href="https://mathking.kr/moodle/local/augmented_teacher/students/today_agamotto.php?id='.$studentid.'">history</a>)</td></tr></table><br><table align=center width=100%><tr><td  style="color:white;background-color:#0373fc; font-size:20;" align=center><b>시험결과 및 오답노트 현황</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;오답노트 후 자신감이 생긴 문항이 '.round($recoveryrate,0).'% 입니다.</td></tr></table> <br> <br>  
...
<th scope="col" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">오답 '.($nwrong+$ngaveup).' &nbsp; &nbsp; 예약 '.$nreview.' | 완료 '.$ncomplete.'  &nbsp; &nbsp;<b style="color:red;"> 도전 '.$appraise_result.'</b>  &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/students/imagegrid.php?id='.$studentid.'&ndays=7"target="_blank"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1624791079001.png width=25></a> &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&mode=sol"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1656132615.png width=25></a>
 &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1655957315.png width=25></a> &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&mode=ltm"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1657015275.png width=25></a> &nbsp; <a href="https://mathking.kr/moodle/local/augmented_teacher/bessiboard/replaycjn.php?studentid='.$studentid.'"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1658012742.png width=25></a>&nbsp; <a href="https://mathking.kr/moodle/question/preview.php?courseid=9&studentid='.$studentid.'&mode=retry"target="_blank"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1658042078.png width=25></a></th>
