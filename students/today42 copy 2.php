    ...
    <div class="content-container">
        <div class="nav-controls">
            <div class="header-nav">
                <a href="index42.php?id='.$studentid.'" class="nav-btn">
                    <i class="fas fa-home"></i> 내공부방
                </a>
                <a href="today42.php?id='.$studentid.'&tb=604800" class="nav-btn active">
                    <i class="fas fa-chart-bar"></i> 공부결과
                </a>
                <a href="../alt42/teachingsupport/student_inbox42.php?studentid='.$studentid.'" class="nav-btn">
                    <i class="fas fa-envelope"></i> 메세지함
                </a>
                <a href="goals42.php?id='.$studentid.'" class="nav-btn">
                    <i class="fas fa-target"></i> 목표설정
                </a>
                <a href="schedule42.php?id='.$studentid.'&eid=1&nweek=12" class="nav-btn">
                    <i class="fas fa-clock"></i> 수업시간
                </a>
                <a href="../teachers/timescaffolding42.php?userid='.$studentid.'" class="nav-btn">
