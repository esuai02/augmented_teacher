...
$hoursago=$timecreated-86400;
$daysago2=$timecreated-86400*2;
...
$handwriting=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages WHERE  userid='$studentid' AND feedback > 0 AND feedback < 4 AND timemodified > '$amonthago'  AND timemodified < '$daysago2' ORDER BY tlaststroke DESC ");
...
foreach(array_reverse($result2) as $value) 
    ...
    if($value['student_check']==1)$papertest.='<table style="display: inline-table; background-color:#EBDEDE; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-right: 10px;" align=center><tr><td valign=top><hr style="border: none; border-top: 2px solid; height: 5px;">'.$checkout.'<b><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/focused_analysis.php?id='.$wboardid.'&userid='.$studentid.'"target="_blank">ALT노트 분석</a></b> | '.$usedtime.' | '.$ncommit.'번| <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$wboardid.'"target="_blank">'.$nstroke.'획</a> ('.$tlastupdate.') <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/print_papertest.php?userid='.$studentid.'&wboardid='.$wboardid.'&contentsid='.$contentsid.'&contentstype=1"target="_blank"><img  src="https://www.mathking.kr/moodle/local/augmented_teacher/IMAGES/printer2.png" width=20></a><hr><img src="'.$imgSrc.'" width="400"><br></td></tr></table>'; 
    else $papertest.='<table style="display: inline-table; background-color:#FFFFFF; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-right: 10px;" align=center><tr><td valign=top><hr style="border: none; border-top: 2px solid; height: 5px;">'.$checkout.'<b><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/focused_analysis.php?id='.$wboardid.'&userid='.$studentid.'"target="_blank">ALT노트 분석</a></b> | '.$usedtime.' | '.$ncommit.'번| <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$wboardid.'"target="_blank">'.$nstroke.'획</a>  ('.$tlastupdate.') <hr><img src="'.$imgSrc.'" width="400"><br></td></tr></table>'; 
	...
	<table align=center><tr><td valign=top><table width=100%><thead><tr><th width=30%><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/synergetic.php?id='.$USER->id.'&userid='.$studentid.'"><img style="margin-top:5px;" src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/circulation.png width=40></a> <span style="font-size:30px;margin-bottom:10px;"><a style="text-decoration:none;color:#3D71FF;font-size:30px;" href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$studentid.'&tb=604800"target="_blank">'.$stdname.'</a>의  ALT Dashboard</span></th><th>(기초 | 기본 | 중급 | 심화 | 고난도)'.$notetitle.'   </th></tr></thead></table><table><tr><td><hr></td><td><hr></td><td><hr></td></tr></table>'.$papertest.'</div></td></tr></table></div>';
