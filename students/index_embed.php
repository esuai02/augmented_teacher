...
foreach($result as $value)
	...
	if($mtid==7)
	echo '<tr><td> <input type="checkbox"  onclick="changecheckbox(1,'.$studentid.','.$mid.', this.checked)"/><br></td><td><div class="tooltip4"><a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$subject.'&nch=1&studentid='.$studentid.'&type=init"target="_blank"><img style="margin-bottom:4px;" src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/gpt3.png width=20> GPT '.$subjectname.$text.'<span class="tooltiptext4"><table style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; " align=center><tr><td>진행현황<hr>데드라인<hr>점수</td></tr></table></span></div> <br></td><td>'.$passgrade.'점</td><td>'.$deadline.'</td></tr>';

	else echo '<tr><td> <input type="checkbox"  onclick="changecheckbox(1,'.$studentid.','.$mid.', this.checked)"/><br></td><td><div class="tooltip4"><a href="https://mathking.kr/moodle/local/augmented_teacher/students/missionhome.php?id='.$studentid.'&mtid='.$mtid.'&cid='.$subject.'&tb=90" target=_blank>'.$subjectname.$text.'<span class="tooltiptext4"><table style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; " align=center><tr><td>진행현황<hr>데드라인<hr>점수</td></tr></table></span></div> <br></td><td>'.$passgrade.'점</td><td>'.$deadline.'</td></tr>';
