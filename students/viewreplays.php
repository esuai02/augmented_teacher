...
if($mode==='peer')
	...
	$replay3=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages where contentsid='$contentsid' AND contentstype='2' AND  (status='attempt' OR status='complete')  ORDER BY nstroke DESC LIMIT 30");  
	...
	echo '<table width=100%><tr><th><tr><th><iframe style="border: 1px none; z-index:2; width:99vw;height:90vh;  margin-left: -0px;margin-right: -0px; margin-top: 0px; "  src="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_topic.php?id='.$wboardid.'" ></iframe></th></tr> 
...
elseif($mode==='sol')
	...
	$replay1=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages where userid LIKE '$studentid' AND contentstype=2 AND status='attempt' AND tlaststroke >'$halfdayago' ORDER BY nstroke DESC LIMIT 10");  $result1 = json_decode(json_encode($replay1), True);
	...
	foreach( $result1 as $value1)
		...
		$contentslink='<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'" target="_blank" ><img src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/BESSI1603205245001.png width=15></a>';  
		 ...
		 if($wboardid===$value1['wboardid'])$view1.='<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=sol"><b style="color:red;">'.$value1['nstroke'].'획</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div>  &nbsp;';
		 else $view1.='<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=sol">'.$value1['nstroke'].'획</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div> &nbsp; ';
		}
 
	$replay2=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages where userid LIKE '$studentid' AND contentstype=2 AND status='attempt' AND tlaststroke >'$halfdayago' AND nstroke NOT LIKE 'NULL' ORDER BY nstroke ASC LIMIT 10");  $result2 = json_decode(json_encode($replay2), True);
	...
	foreach( $result2 as $value2)
		...
		if($wboardid===$value2['wboardid'])$view2.='<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value2['wboardid'].'&mode=sol"><b style="color:red;">'.$value2['nstroke'].'회</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div>   &nbsp;';
		else $view2.='<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value2['wboardid'].'&mode=sol">'.$value2['nstroke'].'획</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table></span></div>  &nbsp; ';
		}
...
elseif($mode==='today')
	...
	foreach( $result1 as $value1)
		...
		if($value1['boardtype']==='duplicate')$styleinfo='font-size:12px';
		elseif($value1['status']==='neuroboard' || $value1['status']==='boost')$styleinfo='font-size:8px';
		elseif($value1['boardtype']==='test')$styleinfo='font-size:20px';
		...
		$contentslink='<a href="https://mathking.kr/moodle/question/preview.php?courseid=9&id='.$contentsid.'" target="_blank" ><img src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/BESSI1603205245001.png width=15></a>';  
 		if($tamount>10)
			{
			if($wboardid===$value1['wboardid'])$view1.=$cnticon.'<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today"><b  style="font-size:24px;color:purple;">'.date("h:i", $value1['tlaststroke']).'</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div>  &nbsp;';
		 	else $view1.=$cnticon.'<div class="tooltip3"> <a style="'.$styleinfo.';color:red;" href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today">'.date("h:i", $value1['tlaststroke']).'</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div> &nbsp; ';
			}
 		elseif($tamount>=5)
			{
			if($wboardid===$value1['wboardid'])$view1.=$cnticon.'<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today"><b  style="font-size:24px;color:purple;">'.date("h:i", $value1['tlaststroke']).'</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div>  &nbsp;';
		 	else $view1.=$cnticon.'<div class="tooltip3"> <a style="'.$styleinfo.';color:blue;" href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today">'.date("h:i", $value1['tlaststroke']).'</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div> &nbsp; ';
			}
 		elseif($tamount>=0.1)
			{
			if($wboardid===$value1['wboardid'])$view1.=$cnticon.'<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today"><b  style="font-size:24px;color:purple;">'.date("h:i", $value1['tlaststroke']).'</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div>  &nbsp;';
		 	else $view1.=$cnticon.'<div class="tooltip3"> <a style="'.$styleinfo.';color:green;" href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today">'.date("h:i", $value1['tlaststroke']).'</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div> &nbsp; ';
			}
 		else
			{
			if($wboardid===$value1['wboardid'])$view1.=$cnticon.'<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today"><b  style="font-size:24px;color:purple;">'.date("h:i", $value1['tlaststroke']).'</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div>  &nbsp;';
		 	else $view1.=$cnticon.'<div class="tooltip3"> <a style="'.$styleinfo.';color:#b1b2b5;" href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=today">'.date("h:i", $value1['tlaststroke']).'</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획 <hr></span></div> &nbsp; ';
			}
		}
 

	echo '<table width=100%><tr><th><tr><th><iframe style="border: 1px none; z-index:2; width:99vw;height:90vh;  margin-left: -0px;margin-right: -0px; margin-top: 0px; "  src="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/replay.php?id='.$wboardid.'&speed=+9" ></iframe></th></tr> 
 	</table><table align=center><tr><th align=left><a href="https://mathking.kr/moodle/local/augmented_teacher/students/today.php?id='.$studentid.'&tb=604800">'.$studentname.'</a> | <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$summary->wboardid.'&mode=today">예측</a> | <a href="https://mathking.kr/moodle/local/augmented_teacher/students/flowhistory.php?studentid='.$studentid.'">메타인지</a> |
 	<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_onair.php?userid='.$studentid.'&mode=1">Onair</a>  '.$view1.'</th></tr></table>';
	}
elseif($mode==='mathtown')
	{
	$stdtname= $DB->get_record_sql("SELECT lastname, firstname FROM mdl_user WHERE id='$studentid' ");
	$studentname=$stdtname->firstname.$stdtname->lastname;
	...
	foreach( $result1 as $value1)
		...
		if($wboardid===$value1['wboardid'])$view1.=$cnticon.'<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=mathtown&tfinish='.$tfinish.'"><b  style="font-size:30px;color:#4287f5;">'.date("h:i", $value1['tlaststroke']).'</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div>  &nbsp;';
		 else $view1.=$cnticon.'<div class="tooltip3"> <a style="font-size:16px;color:black;" href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=mathtown&tfinish='.$tfinish.'">'.date("h:i", $value1['tlaststroke']).'</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획 <hr></span></div> &nbsp; ';
...
elseif($mode==='remind')
	...
	foreach( $result1 as $value1)
		...
		if($wboardid===$value1['wboardid'])$view1.=$cnticon.'<div class="tooltip3"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=remind&tfinish='.$tfinish.'"><b  style="font-size:30px;color:#4287f5;">'.date("h:i", $value1['tlaststroke']).'</b></a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획<hr></span></div>  &nbsp;';
		 else $view1.=$cnticon.'<div class="tooltip3"> <a style="font-size:16px;color:black;" href="https://mathking.kr/moodle/local/augmented_teacher/students/viewreplays.php?id='.$studentid.'&wboardid='.$value1['wboardid'].'&mode=remind&tfinish='.$tfinish.'">'.date("h:i", $value1['tlaststroke']).'</a><span class="tooltiptext3"><table style="" align=center><tr><td>'.$questiontext.'</td></tr></table>'.$value1['wboardid'].' | '.$tamount.'분 | '.$value1['nstroke'].'획 <hr></span></div> &nbsp; ';
