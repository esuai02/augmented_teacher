...
$engagement2 = $DB->get_record_sql("SELECT id,timecreated FROM  mdl_logstore_standard_log WHERE userid='$studentid'  ORDER BY id DESC LIMIT 1 ");  // mathkinglog
...
if($readtime->id==NULL && ($USER->id==$studentid || $role!=='student')) $DB->execute("INSERT INTO {abessi_indicators} (userid,timemodified,timecreated) VALUES('$studentid','$timecreated','$timecreated')");
$mbtilog= $DB->get_record_sql("SELECT * FROM mdl_abessi_mbtilog WHERE userid='$studentid' AND type='present' ORDER BY id DESC LIMIT 1"); 
...
$checkgoal2= $DB->get_record_sql("SELECT * FROM  mdl_abessi_today WHERE userid='$studentid' AND (type LIKE '오늘목표' OR type LIKE '검사요청') AND timecreated>'$halfdayago' ORDER BY id ASC LIMIT 1 ");
$tgoal=$checkgoal2->timecreated;  // 오늘 목표 입력 여부
if($checkgoal2->id==NULL)$tgoal=$timecreated;
...
$termplan= $DB->get_record_sql("SELECT  id,deadline,memo,dreamchallenge,dreamtext,dreamurl FROM mdl_abessi_progress WHERE userid='$studentid' AND plantype ='분기목표' AND hide=0    ORDER BY id DESC LIMIT 1  ");
...
$mid=7;
$breaktime=$DB->get_record_sql("SELECT timedelayed FROM mdl_abessi_breaktimelog WHERE userid='$studentid' AND timecreated > '$halfdayago' ORDER BY id DESC LIMIT 1");
$tremain=(INT)((($tgoal+$hours*3600+$breaktime->timedelayed)-$timecreated)/60);
...
$imgstatus= '<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_onair.php?userid='.$studentid.'&mode=1" accesskey="w"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1624721323001.png width=80></a>&nbsp;&nbsp;&nbsp;&nbsp;'.$mark4.'&nbsp;<a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/calmness.php?id='.$studentid.'&tb=604800" accesskey="l"><img loading="lazy" src='.$imgtoday.' width=35></a><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/Preloader2.gif" width=60 ><img loading="lazy" src='.$imgtoday2.' width=35></a>&nbsp;&nbsp;'.$mark5. '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'; 
...
<li class="nav-item '.$currentpage4.'">
									<a href="https://mathking.kr/moodle/local/augmented_teacher/alt42/teachingsupport/student_inbox.php?studentid='.$studentid.'"target="_blank">
									<i class="flaticon-result"></i>
									<p>AI피드백</p>
						...
						<li class="nav-item">
							<a href="https://mathking.kr/moodle/local/augmented_teacher/students/Alphi/growthmindset.php?id='.$studentid.'">
								<i>🧠</i>
								<p>성장 마인드</p>
							</a> 
						</li>
						<li class="nav-item">
							<a href="https://mathking.kr/moodle/local/augmented_teacher/books/inspiregrowth.php?userid='.$studentid.'">
					...
					<table align=center><tr><td><audio controls style="width:100px;height:20px;" 
                       src="https://mathking.kr/Contents/Management/KTM%20%ED%95%99%EC%8A%B5%20%EC%8B%9C%EC%8A%A4%ED%85%9C%20%EB%A7%A4%EB%89%B4%EC%96%BC%20%28%ED%95%99%EC%83%9D%29.wav">
                </audio></td></tr></table>
					</li> </ul>';
				...
				<div class="container-fluid">
					 ...
					 <table width=100%><tr><td  width=2%></td>					 
							<td valign=top>
										...
										<tr><td align=center width=200px>도움요청</td><td align=center style="font-size:12px;"><a href="https://mathking.kr/moodle/local/augmented_teacher/twinery/목표%20메타인지.html"target="_blank"><img loading="lazy" src=https://mathking.kr/moodle/local/augmented_teacher/IMAGES/detail.png width=20></a></td>
										...
										<td align=center style="white-space:nowrap;">'.$generateontology.' <a href="https://mathking.kr/moodle/local/augmented_teacher/students/Alphi/myalphi.php?studentid='.$studentid.'">My Alphi</a></td></tr></table></td><td  width=2%></td></tr></table>
										 </div><table align=center width=95%><tr><td align=right><hr style="border: solid 0.5px lightblue;"> </td></tr></table> </div>';
