...
<body class="bg-gray-50 text-gray-800">
        ...
        <div class="w-24 bg-indigo-700 text-white flex flex-col items-center pt-6 pb-6">
            <div class="mb-8">
                <div class="h-12 w-12 rounded-full bg-white flex items-center justify-center">
                    <i class="fas fa-brain text-indigo-700 text-xl"></i>
                </div>
            </div>
            ...
            <nav class="flex flex-col items-center space-y-8 flex-grow">
                ...
                <a href="#" data-tab="journal" class="tab-btn p-3 rounded-xl flex flex-col items-center w-16">
                    ...
                    <span class="text-xs mt-1">저널</span>
                </a>
                
                <a href="#" data-tab="progress" class="tab-btn p-3 rounded-xl flex flex-col items-center w-16">
                    <i class="fas fa-chart-bar text-xl"></i>
                    <span class="text-xs mt-1">성장</span>
                </a>
            ...
            <header class="h-16 bg-white shadow-sm flex items-center px-6 justify-between">
                ...
                <div class="flex items-center">
                    ...
                    <div class="h-10 w-10 rounded-full bg-indigo-100 flex items-center justify-center">
                        <span class="font-semibold text-indigo-700">민지</span>
                    </div>
                </div>
            </header>
                    ...
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center mb-6">
                                ...
                                <div>
                                    <h3 class="font-medium">셋 ! 수학공부 잘하는 마인드셋</h3>
                                    <p class="text-sm text-gray-500">수학공부에 응용하기 (약 17분)</p>
                                </div>
                                <a href="https://www.youtube.com/watch?v=T-vL_bFxm30" target="_blank" class="ml-auto flex items-center bg-indigo-600 text-white rounded-full px-4 py-2">
                                    <span>영상보기</span>
                                    <i class="fas fa-chevron-right ml-1"></i>
                                </a>
                            </div>
                ...
                <div id="journal-content" class="tab-content">
                    <div class="bg-white rounded-xl shadow-sm p-12 text-center">
                        <div class="flex flex-col items-center justify-center">
                            ...
                            <h2 class="text-2xl font-bold text-indigo-800 mb-2">저널 기능 준비중</h2>
                            <p class="text-gray-600 mb-6">성장 마인드셋 저널 기능이 곧 제공될 예정입니다.</p>
                            <p class="text-sm text-gray-500">더 나은 성찰 경험을 위해 열심히.준비하고 있습니다.</p>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function showMathMindset(areaId) {
            ...
            // 선택된 영역의 컨텐츠 표시
            if (contents[areaId]) {
                content.innerHTML = contents[areaId].content;
                ...
                content.style.animation = 'scrollCredits 60s linear forwards';
            }
        }
