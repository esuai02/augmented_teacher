 ...
 * 파일: students/install_short_php.php
 */
...
$source_file = __DIR__ . '/../moodle_root_short_simple.php';
...
?>';
    ...
    if (file_put_contents($target_file, $file_content)) {
        ...
        echo '<div class="success">
            ...
            설치 위치: <code>' . htmlspecialchars($target_file) . '</code>
        </div>';
    ...
    echo '<div class="error">
        ...
        1. <code>moodle_root_short_simple.php</code> 파일을 서버에 업로드<br>
        2. 파일명을 <code>short.php</code>로 변경<br>
        3. 위치: <code>/home/moodle/public_html/moodle/short.php</code>
    </div>';
}
