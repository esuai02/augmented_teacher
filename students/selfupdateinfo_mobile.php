		...
		{ 
			...
			type: "POST",
 			  ...
 			  data : {
				...
				if(Userid2==0)
					{
					window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid1+"&eid=2&nweek=8"; 
				             }
				else if(Userid3==0)
					{  		 
						swal("사용자 선택하기",  "",{
						...
						.then((value) => {
						  switch (value) {
						     case "defeat":
			  			    ...
			  			    break;			 
 			 			  case "catch1": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid1+"&eid=2&nweek=8"; break;
 			 			  case "catch2": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid2+"&eid=2&nweek=8"; break; 			 		
 						  default:
						      swal("취소되었습니다.", {buttons: false,timer: 500});
						       }
						});
					...
					{  		 
						...
						.then((value) => {
						  switch (value) {
 			 			  ...
 			 			  case "catch1": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid1+"&eid=2&nweek=8"; break;
 			 			  case "catch2": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid2+"&eid=2&nweek=8"; break;
 			 			  case "catch3": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid3+"&eid=2&nweek=8"; break;
 						  default:
						      swal("취소되었습니다.", {buttons: false,timer: 500});
						       }
						});
					...
					{  		 
						...
						.then((value) => {
						  switch (value) {
 			 			  ...
 			 			  case "catch2": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid2+"&eid=2&nweek=8"; break;
 			 			  case "catch3": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid3+"&eid=2&nweek=8"; break;
 			 			  case "catch4": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid4+"&eid=2&nweek=8"; break;
 						  default:
						      swal("취소되었습니다.", {buttons: false,timer: 500});
						       }
						});
					...
					{  		 
						...
						.then((value) => {
						  switch (value) {
 			 			  ...
 			 			  case "catch3": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid3+"&eid=2&nweek=8"; break;
 			 			  case "catch4": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid4+"&eid=2&nweek=8"; break;
 			 			  case "catch5": window.location.href="https://mathking.kr/moodle/local/augmented_teacher/students/attendance.php?id="+Userid5+"&eid=2&nweek=8"; break;
 						  default:
						      swal("취소되었습니다.", {buttons: false,timer: 500});
						       }
						});
