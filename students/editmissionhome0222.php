				...
				<div class="row"> 
						<div class="col-md-8">
							<div class="card">
								...
								<div class="card-body">
<table class="table table-hover"><thead><tr><th scope="col">#</th><th scope="col">단원명</th><th scope="col">인증시험 (통과 : '.$mission->grade.' 점)</th><th scope="col">난이도</th>
<th scope="col">&nbsp;&nbsp; 
...
<td><a href="https://mathking.kr/moodle/mod/quiz/view.php?id='.$qid.'" target="_blank">인증시험 ('.$grade.'점)</a></td><td>보통</td><td>
...
<td><button type="button" onclick="editschedule(13,'.$studentid.','.$cid.',$(\'#datepicker1\').val(),$(\'#datepicker2\').val(),$(\'#datepicker3\').val(),
...
$(\'#datepicker12\').val(),$(\'#datepicker13\').val(),$(\'#datepicker14\').val(),$(\'#datepicker15\').val())
;savehours(13,'.$studentid.','.$cid.',$(\'#datepicker1\').val(),$(\'#datepicker2\').val(),$(\'#datepicker3\').val(),
$(\'#datepicker4\').val(),$(\'#datepicker5\').val(),$(\'#datepicker6\').val(),$(\'#datepicker7\').val(),$(\'#datepicker8\').val(),$(\'#datepicker9\').val(),$(\'#datepicker10\').val(),$(\'#datepicker11\').val(),
$(\'#datepicker12\').val(),$(\'#datepicker13\').val(),$(\'#datepicker14\').val(),$(\'#datepicker15\').val())">  


<a href="https://mathking.kr/moodle/local/augmented_teacher/students/missionhome.php?id='.$studentid.'&cid='.$cid.'&mtid='.$mtid.'&tb=90">저장하기</a></button>
</td></tr>
...
if($mtid==3 ||$mtid==4) // 내신미션
	...
	foreach($getresult as $value)
		...
		foreach($result2 as $value2)
			{
			$name='quiz'.$num;
			$$name=substr($value2['displaytext'], 0, strpos($value2['displaytext'], "{if"));
			$quizid='quizid'.$num;
...
<div class="card-title">'.$curri->name.' .............. 시험기간 :   ................ 시험범위 : ............. 총 (   ) 단계</div></div><div class="card-body">
<table class="table table-hover"><thead><tr><th scope="col" width=5%>#</th><th scope="col" width=40%>내신 테스트 유형</th><th scope="col" width=15%>통과 점수</th><th scope="col" width=15%>예상 소요시간</th>
...
for($nch=1;$nch<=$nmax;$nch++)
	...
	$passgrade='passgrade'.$nch;
	$duration='duration'.$nch;
	...
	echo'<tr><td>'.$nch.'</td><td><a href="https://mathking.kr/moodle/mod/quiz/view.php?id='.$qid.'" target="_blank">인증시험 ('.$grade.'점)</a></td>
	<td><div class="select2-input"><select id="basic1" name="basic1" class="form-control" ><option value="'.$$passgrade.'">'.$$passgrade.'</option><option value="70">70점</option><option value="75">75점</option><option value="80">80점</option><option value="85">85점</option><option value="90">90점</option><option value="95">95점</option> <option value="100">100점</option></select></div></td>
	<td><div class="select2-input"><select id="basic2" name="basic2" class="form-control" ><option value="'.$$duration.'">'.$$duration.'</option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option>
	<option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option><option value="32">32</option><option value="33">33</option><option value="34">34</option><option value="35">35</option><option value="36">36</option><option value="37">37</option><option value="38">38</option><option value="39">39</option><option value="40">40</option><option value="41">41</option><option value="42">42</option><option value="43">43</option><option value="44">44</option><option value="45">45</option><option value="46">46</option><option value="47">47</option><option value="48">48</option></select></div></td>
	<td>
	<input type="text" class="form-control" id="'.$datepicker.'"  value="'.$getdate2.'"></td></tr>';  //******************************************************************************input
	}
$mission=$DB->get_record_sql("SELECT * FROM mdl_abessi_mission where complete=0 AND subject='$cid' AND userid='$studentid' ORDER BY id DESC LIMIT 1 ");
...
echo '
	...
	<script>		
		...
		function savehours(Eventid,Userid,Subject,Hour1,Hour2,Hour3,Hour4,Hour5,Hour6,Hour7,Hour8,Hour9,Hour10,Hour11,Hour12,Hour13,Hour14,Hour15)
		{		
		        $.ajax({
		            url:"database.php",
			type: "POST",
