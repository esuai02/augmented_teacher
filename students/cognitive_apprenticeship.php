...
echo ' 
	...
	<table align="center"><tr><th  align=center width=33%> <a href="" taget="_blank">질문하기</a></th><th  align=center  width=33%>  <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_homework.php?id='.$wboardid.'&userid='.$studentid.'&cnttype='.$contentstype.'&cntid='.$contentsid.'&nstep='.$nstep1.'" target="_blank">참고자료</a></th><th align=center width=40%>  <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_homework.php?id='.$wboardid.'&userid='.$studentid.'&cnttype='.$contentstype.'&cntid='.$contentsid.'&nstep='.$nstep1.'" target="_blank">큰 화면으로</a></th></tr> </table><br>
	</div>
	</div>	     
	</div>
	      ';
