	...
	<div class="wrapper">
			<div class="content">
				<div class="container-fluid"> <br>
					<!-- TimeLine -->
					<table align=center><tr style="font-size:14px;"><td align=right height=25>'.$username->firstname.$username->lastname.'의 <a href="https://mathking.kr/moodle/local/augmented_teacher/students/timelineWeek.php?id='.$studentid.'&tb=604800"><button>학습목표</button></a><a href="https://mathking.kr/moodle/local/augmented_teacher/students/timefoldingfeedback.php?id='.$studentid.'&tb=604800"><button style="background-color:skyblue;">전략개선</button></a></td></tr>
