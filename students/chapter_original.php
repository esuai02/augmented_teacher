...
global $DB, $USER;
include("navbar.php");
//$chapterid=required_param('bookid', PARAM_INT); 
$cmid=82706;
...
echo ' 
 ...
 <div id="collapse'.$cmid2.'" class="panel-collapse collapse">
	...
	foreach($result3 as $value3) // 소주제 반복생성
 		{
		$title=$value3['title'];  // 소주제명
		$nstep++;
		$pageid=$value3['id'];
		$wboardid='pageid'.$pageid.'jnrsorksqcrark'.$studentid.'beingsullivan';
		    ...
		    <div class="panel">
	                  <div class="panel-heading child">
	                    <h5 class="panel-title">
	                      <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion'.$cmid2.'" href="#collapse'.$cmid2.$nstep.'" aria-expanded="false"><span style="color:white">'.$title.'</span></a>
	                    </h5>
	                  </div>
	                  <div id="collapse'.$cmid2.$nstep.'" class="panel-collapse collapse">
	                  
              <div class="panel-body">	     
	<iframe src="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_homework.php?id='.$wboardid.'"  style="border: 0px none; width:100%; margin-left: 0px; height:50%; margin-top: 0px;"></iframe>
	<hr><table align=center widht=60%><tr><th width=50%> <a href="" taget="_blank">질문하기</a></th><th width=50%>  <a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board_homework.php?id='.$wboardid.'" target="_blank">큰 화면으로 이동</a></th></tr> </table><hr>
	</div> 
	                  </div>
	                </div>
	              </div>
...
/*
		...
		//<img src="https://mathking.kr/IMG/HintIMG/BESSI1594118432001.png" width=30></a></td><td><input type="checkbox"  onclick="changecheckbox2(9,\''.$studentid.'\',\''.$wboardid.'\',\''.$pageid.'\', this.checked)"/></td></tr></table></li>';
		//else $items.='<li class="list-group-item"><table><tr><td><a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$wboardid.'" target="_blank"><h5>'.$cnttitle.'</h5></a></td><td>&nbsp;</td><td><input type="checkbox"  onclick="changecheckbox(8,\''.$studentid.'\',\''.$wboardid.'\', this.checked)"/></td></tr></table></li>';
