    ...
    <div class="container mt-4">
      <div class="card">
        ...
        <div class="card-body">
          <form>
            <div class="row mb-3">
              <label class="col-md-4 col-form-label text-end">과목선택</label>
              <div class="col-md-4">
                '.$subject_field.'
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-md-4 col-form-label text-end">시작'.$unit.'</label>
              <div class="col-md-4">
                '.$chstart_field.'
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-md-4 col-form-label text-end">소요시간</label>
              <div class="col-md-4">
                '.$chhours_field.'
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-md-4 col-form-label text-end">주별시간</label>
              <div class="col-md-4">
                '.$weekhours_field.'
              </div>
            </div>
            <div class="row mb-3">
              <label class="col-md-4 col-form-label text-end">합격점수</label>
              <div class="col-md-4">
                '.$grade_field.'
              </div>
            </div>
            <div class="row mb-4">
              <label class="col-md-4 col-form-label text-end">시작날짜</label>
              <div class="col-md-4">
                '.$date_field.'
              </div>
            </div>
            <div class="text-center">
              <button type="button" class="btn btn-primary" onclick="saveAndRedirect()">
                저장하기
              </button>
            </div>
          </form>
