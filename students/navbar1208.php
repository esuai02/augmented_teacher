...
$messageicon1='<a href="https://mathking.kr/moodle/local/augmented_teacher/books/chapter.php?cid='.$chapterlog->cid.'&cntid='.$chapterlog->cntid.'&nch='.$chapterlog->nch.'&studentid='.$studentid.'&type=init"><img style="margin-bottom:0px;" src=https://mathking.kr/Contents/IMAGES/timefolding.png width=40></a>';
...
elseif($weeklyGoal->id==NULL)$goaldisplay= '<span style="color:black;"> <a style="text-decoration:none;color:white;" href=" https://mathking.kr/moodle/local/augmented_teacher/students/weeklyplans.php?id='.$studentid.'&cid='.$chapterlog->cid.'&pid='.$termplan->id.'"target="_blank">'.$EGinputtime.'까지</a> 계획이</span> <span style="color:#EEFF00;">'.$termMission.'</span><span style="color:black;">입니다. </span><a style="color:white;" href="https://mathking.kr/moodle/local/augmented_teacher/students/edittoday.php?id='.$studentid.'"><span style="color:white;">주간목표</span></a>  <span style="color:black;">를 입력해 주세요 !</span>';
else $goaldisplay= '<span style="color:black;"> <a style="text-decoration:none;color:white;" href=" https://mathking.kr/moodle/local/augmented_teacher/students/weeklyplans.php?id='.$studentid.'&cid='.$chapterlog->cid.'&pid='.$termplan->id.'"target="_blank">'.$EGinputtime.'까지</a> 계획이</span> <span style="color:#EEFF00;">'.$termMission.'</span><span style="color:black;"> 이어서 이번 주는</span> <span style="color:#EEFF00;">'.$weeklyGoal->text.'</span><span style="color:black;">(을)를 목표로 정진 중입니다.</span>';
