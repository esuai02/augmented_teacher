...
$link7=$cntsteps->link7;
	...
	$cogwboard='nr1rjrk0sc0akscnttype'.$contentstype.$contentsid.$nstep.$studentid; // 단계별 화이트보드 아이디
...
if($contentstype==1)
	...
	echo '<p align="center"><img align=center src="'.$imgSrc.'"></p> ';
	}
if($contentstype==2)
	{  
	$getimg=$DB->get_record_sql("SELECT questiontext FROM mdl_question WHERE id ='$contentsid' ");
	$ctext=$getimg->questiontext; 
	$htmlDom = new DOMDocument;
	@$htmlDom->loadHTML($ctext);
	$imageTags = $htmlDom->getElementsByTagName('img');
	$extractedImages = array();
...
//    <table width=100% align=center><tr><td><h4><a href="https://mathking.kr/moodle/local/augmented_teacher/students/cognitive_steps_subject.php?id='.$studentid.'&cntid='.$contentsid.'&cnttype='.$contentstype.'&recommend='.$recommend.'&nstep='.$prev.'">◁</a></h4></td><td><h4 align=center><span style="color:black">'.$nstep.'단계 : '.$explaintitle.' </span></h4></td><td>'.$linkicon.'</td><td align=right><h4><a href="https://mathking.kr/moodle/local/augmented_teacher/students/cognitive_steps.php?id='.$studentid.'&cntid='.$contentsid.'&cnttype='.$contentstype.'&recommend='.$recommend.'&nstep='.$next.'">▷</a></h4></td></tr></table>

echo ' 
<hr>
   <table width=100% align=center><tr><td><h4><a href="https://mathking.kr/moodle/local/augmented_teacher/students/cognitive_steps_subject.php?id='.$studentid.'&cntid='.$contentsid.'&cnttype='.$contentstype.'&recommend='.$recommend.'&nstep='.$prev.'">◁</a></h4></td><td><h4 align=center><span style="color:black">'.$explaintitle.' </span></h4></td><td>'.$linkicon.'</td><td align=right><h4><a href="https://mathking.kr/moodle/local/augmented_teacher/students/cognitive_steps_subject.php?id='.$studentid.'&cntid='.$contentsid.'&cnttype='.$contentstype.'&recommend='.$recommend.'&nstep='.$next.'">▷</a></h4></td></tr></table>           
<hr>
