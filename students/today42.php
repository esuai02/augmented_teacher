...
// Set current page status for today42.php
if(strpos($url, 'today42.php')!= false)
	{
...
<div class="nav-top">
    <div class="content-container">
        <div class="nav-controls">
            ...
            <a href="https://mathking.kr/moodle/local/augmented_teacher/students/today42.php?id='.$studentid.'" class="nav-btn active">
            📝 오늘
            </a>
            ...
            <a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/timescaffolding42.php?userid='.$studentid.'" class="nav-btn">
                📅 수학일기
            </a>
...
function toggleView() {
    ...
    if (currentIcon.includes("fa-folder")) {
        // Switch to tab view
        icon.className = "fas fa-th-large";
        container.className = "sections-container tab-view";
        console.log("Switched to tab view");
    } else {
        // Switch to scroll view
        icon.className = "fas fa-folder";
        container.className = "sections-container scroll-view";
        console.log("Switched to scroll view");
    }
}
...
function switchTab(tabIndex) {
    ...
    if (document.getElementById(`section${tabIndex}`)) {
...
foreach($quizresult as $value) 
	{
		...
		if($quizgrade>79.99)
			{
			$imgstatus='<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/greendot.png" width="15"><span class="tooltiptext3">우수 (80점 이상)</span></div>';
			}
		elseif($quizgrade>69.99)
			{
			$imgstatus='<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/bluedot.png" width="15"><span class="tooltiptext3">양호 (70-79점)</span></div>';
			}
		else $imgstatus='<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/Moodle/Visual%20arts/reddot.png" width="15"><span class="tooltiptext3">개선필요 (70점 미만)</span></div>';
		$quizid=$value['quiz'];
		...
		if($value['state']==='inprogress' && $role==='student')$modifyquiz='<span onclick="addquiztime(\''.$attemptid.'\')"><div class="tooltip3"><img loading="lazy" src=https://mathking.kr/Contents/IMAGES/addtime.png width=25><span class="tooltiptext3">시간 추가하기</span></div></span>'; 
		elseif($value['state']==='inprogress' && $role!=='student')$modifyquiz='<span onclick="deletequiz(\''.$attemptid.'\')"><div class="tooltip3"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1641497146.png width=15><span class="tooltiptext3">퀴즈 삭제</span></div></span> <span onclick="addquiztime(\''.$attemptid.'\')"><div class="tooltip3"><img loading="lazy" src=https://mathking.kr/Contents/IMAGES/addtime.png width=25><span class="tooltiptext3">시간 추가하기</span></div></span>';
		elseif($role!=='student')$modifyquiz='<span onclick="deletequiz(\''.$attemptid.'\')"><div class="tooltip3"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1641497146.png width=15><span class="tooltiptext3">퀴즈 삭제</span></div></span>';
...
$checkstatus='';
$fixhistory='<a href="https://mathking.kr/moodle/local/augmented_teacher/whiteboard/board.php?id='.$encryption_id.'" target="_blank">노트 </a><a href="https://mathking.kr/moodle/local/augmented_teacher/teachers/print_papertest.php?userid='.$studentid.'&wboardid='.$encryption_id.'&contentsid='.$contentsid.'&contentstype=2" target="_blank"><div class="tooltip3"><img loading="lazy" style="margin-bottom:3px;" src="https://www.mathking.kr/moodle/local/augmented_teacher/IMAGES/printer.png" width=15><span class="tooltiptext3">인쇄하기</span></div></a>';
...
if($status==='exam' && $timecreated-$value['timereviewed']>600)$imgstatus='<div class="tooltip3"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/exam2.png" width="15"><span class="tooltiptext3">시험 시작</span></div><span style="color: rgb(33, 33, 233);"> 시작</span>';
elseif($status==='sequence')$imgstatus='<div class="tooltip3"><img src="https://mathking.kr/Contents/IMAGES/sequence.png" width="15"><span class="tooltiptext3">순서 학습</span></div><span style="color: rgb(33, 33, 233);"> 순서</span>';
elseif($status==='evidence' || $status==='modify' || $status==='explain' || $status==='direct')$imgstatus='<div class="tooltip3"><img src="https://mathking.kr/Contents/IMAGES/logic.png" width="15"><span class="tooltiptext3">논리적 사고</span></div><span style="color: rgb(33, 33, 233);"> 논리</span>';
elseif($status==='fixsol')$imgstatus='<div class="tooltip3"><img src="https://mathking.kr/moodle/local/augmented_teacher/IMAGES/fixsol.png" width="15"><span class="tooltiptext3">다시 풀기</span></div><span style="color: rgb(33, 33, 233);"> 다시</span>';
...
if($value['status']==='flag' && $value['timemodified']>$adayAgo && $value['contentstitle']!=='incorrect' )
	...
	if($value['helptext']==='OK' || ($nstroke>15 && $bstep->nthink==0)){ $nthinktext='OK'; $imgstatus='<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/BESSI1600204469001.png" width="15"><span class="tooltiptext3">북마크 완료</span></div> 책갈피';  }
...
elseif($value['timemodified']<=$adayAgo && $value['status']!=='flag'  && $value['helptext']!=='해결') 
	...
	if($status==='review' && $value['hide']==0 )
		...
		if($value['status']==='review' && time()> $value['treview'])
			{
			$nreview2++;
			$imgstatus='<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/MXBESSI1626450444001.png" width="15"><span class="tooltiptext3">복습 예약 문항</span></div>';  // 복습예약 활동문항
...
if($checkgoal->drilling==1)$alertimg='(<div class="tooltip3"><img loading="lazy" style="margin-bottom:5px;" src=https://mathking.kr/Contents/IMAGES/exist.gif width=20><span class="tooltiptext3">특별 드릴링 필요 항목</span></div>)';
else $alertimg='';
$goalid=$checkgoal->id; 
...
if($role!==student)$editgoal='<a href="https://mathking.kr/moodle/local/augmented_teacher/student/edittoday42.php?id='.$studentid.'&mode=CA">입력</a>';
...
// 기존 iframe 영역은 이제 첫 번째 탭(시각자료)으로 이동됨
echo '
			  ...
			  <div class="progress-status">
				...
				<span class="text-muted fw-bold">
				  <b>주간 : </b> 총 '.round($weektotal,1).'시간 <a href="https://mathking.kr/moodle/blocks/use_stats/detail.php?id=152359&course=1&ts_from='.$timefrom.'&userid='.$studentid.'" target="_blank">
					<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/BESSI1601225605001.png" width="15"><span class="tooltiptext3">주간 학습 시간 상세보기</span></div>
				  </a>
				</span> 
			  </div>
			  <div class="progress">
			...
			<div class="progress-card">
			  <div class="progress-status">
				<span class="text-muted">
					...
					<div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/BESSI1601225605001.png" width="15"><span class="tooltiptext3">누적 학습 시간 상세보기</span></div>
				  </a>'.$addtime.' &nbsp;
				  </span>   
			  </div>
			  <div class="progress">
...
if($tamounttotal<=-5 && $attendlog->id !=NULL )$attendancetext='&nbsp; <b>'.$tamounttotal.'시간 </b>&nbsp;&nbsp;<a style="color:red; font-size:16pt" href="https://mathking.kr/moodle/local/augmented_teacher/student/schedule.php?id='.$studentid.'&eid=1&nweek=4">보강시간을 정해주세요 !</a> <div class="tooltip3"><img loading="lazy" src="https://mathking.kr/Contents/IMAGES/exist.gif" width=40><span class="tooltiptext3">긴급: 보강시간 설정 필요</span></div>';
...
// 섹션 컨테이너 시작
echo '<div class="sections-container scroll-view" id="sectionsContainer">
    <!-- Tab Navigation -->
    <div class="tab-nav">
        <button class="tab-nav-item active" onclick="switchTab(0)">
            <i class="fas fa-chart-line"></i> 시각자료
        </button>
...
// 시각자료 섹션 (첫 번째 탭) - 기존 iframe 영역을 여기로 이동
echo '<div class="section active" id="section0">
<table align=center width=100%><tr><td style="color:white;background-color:#28a745; font-size:20;" align=center><b>📊 시각자료</b></td></tr></table><br>
...
<table align=center width=100%><tr><td  style="color:white;background-color:#0373fc; font-size:20;" align=center><b>📊 시험결과</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr></table> <br>  
<table align=center valign=top width=100%><thead> 
<tr>
<th scope="col"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=https://mathking.kr/moodle/local/augmented_teacher/students/today42.php?id='.$studentid.'&tb=604800>1주일</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href=https://mathking.kr/moodle/local/augmented_teacher/students/today42.php?id='.$studentid.'&tb=2592000>1개월</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=https://mathking.kr/moodle/local/augmented_teacher/students/today42.php?id='.$studentid.'&tb=7776000>3개월</a></th>
</tr><tr ><td  style=" vertical-align: top;"><br><b>준비학습</b> <br><br>'.$reviewwb0.$quizlist00.'<br><b>내신테스트</b>  <br><br><table>'.$quizlist11.$quizlist12.'</table><br><b>표준테스트</b>  <br><br><table>'.$quizlist21.$quizlist22.'</table><br><b>인지촉진</b>  <br><br><table>'.$quizlist31.$quizlist32.'</table></td></tr></tbody></table>
<br><br>
</div>';

// 오답노트 섹션 (세 번째 탭)
echo '<div class="section" id="section2">
<table align=center width=100%><tr><td  style="color:white;background-color:#dc3545; font-size:20;" align=center><b>📝 오답노트 현황</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td></tr></table> <br>  
<table align=center valign=top width=100%><thead> 
<tr>
<th scope="col" style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"> <a href="https://mathking.kr/moodle/local/augmented_teacher/students/viewallreplay.php?id='.$studentid.'&mode=today"><div class="tooltip3"><img loading="lazy" src=https://mathking.kr/Contents/MATH%20MATRIX/MATH%20images/IMG/bessi21_1656132615.png width=25><span class="tooltiptext3">KTM 디지털 화이트보드 학습 기록</span></div> KTM 화이트보드</a> 
	...
	$.ajax({
		...
		data : {
			...
			success:function(data)
				...
				setTimeout(function() {
					location.href="https://mathking.kr/moodle/local/augmented_teacher/alt42/studenthome/contextual_agents/beforegoinghome/index.php";
				}, 2000);
				},
		...
		function Resttime(Eventid,Userid, Goalid,Checkvalue)
		    ...
		    if(Checkvalue==true)
				...
				if(Timeleft<0)
					...
					html:
					\'<table align=center ><tr><td align=center><br><h5><b>정보입력이 멈춘 상태의 DMN 휴식</b>을 취하면 공부가 가속화됩니다 !<hr> <a href="https://brunch.co.kr/@kissfmdj/1"target="_blank">멍 때리기의 힘</a><hr><a href="https://www.youtube.com/watch?v=uqK7ydiPEaI"target="_blank">예술작품에 감동하는 뇌</a> </h5><br></td></tr><tr><td><iframe style="border: 1px none; z-index:2; width:60vw;height:50vh; margin-left: -30px;margin-top: 0px;"   src="https://e.ggtimer.com/10minutes" ></iframe></td></tr></table>\',
					})
