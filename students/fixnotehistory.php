...
$handwriting=$DB->get_records_sql("SELECT * FROM mdl_abessi_messages WHERE  userid='$studentid' AND active LIKE '1' AND (status LIKE 'complete' OR status LIKE 'review') ORDER BY tlaststroke DESC ");
